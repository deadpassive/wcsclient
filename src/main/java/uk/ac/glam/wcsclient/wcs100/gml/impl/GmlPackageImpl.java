...
import uk.ac.glam.wcsclient.wcs100.gml.AbstractGeometricPrimitiveType;
...
import uk.ac.glam.wcsclient.wcs100.gml.AbstractMetaDataType;
import uk.ac.glam.wcsclient.wcs100.gml.AbstractRingPropertyType;
import uk.ac.glam.wcsclient.wcs100.gml.AbstractRingType;
import uk.ac.glam.wcsclient.wcs100.gml.AbstractSurfaceType;
import uk.ac.glam.wcsclient.wcs100.gml.BoundingShapeType;
...
import uk.ac.glam.wcsclient.wcs100.gml.DocumentRoot;
import uk.ac.glam.wcsclient.wcs100.gml.EnvelopeType;
import uk.ac.glam.wcsclient.wcs100.gml.EnvelopeWithTimePeriodType;
import uk.ac.glam.wcsclient.wcs100.gml.GmlFactory;
import uk.ac.glam.wcsclient.wcs100.gml.GmlPackage;
import uk.ac.glam.wcsclient.wcs100.gml.GridEnvelopeType;
import uk.ac.glam.wcsclient.wcs100.gml.GridLimitsType;
...
import uk.ac.glam.wcsclient.wcs100.gml.PointType;
import uk.ac.glam.wcsclient.wcs100.gml.PolygonType;
import uk.ac.glam.wcsclient.wcs100.gml.RectifiedGridType;
import uk.ac.glam.wcsclient.wcs100.gml.ReferenceType;
import uk.ac.glam.wcsclient.wcs100.gml.StringOrRefType;
import uk.ac.glam.wcsclient.wcs100.gml.TimeIndeterminateValueType;
import uk.ac.glam.wcsclient.wcs100.gml.TimePositionType;
import uk.ac.glam.wcsclient.wcs100.gml.VectorType;

import uk.ac.glam.wcsclient.wcs100.gml.util.GmlValidator;

import uk.ac.glam.wcsclient.wcs100.impl.Wcs100PackageImpl;
...
public class GmlPackageImpl extends EPackageImpl implements GmlPackage {
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.gml.GmlPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static GmlPackage init() {
		...
		Wcs100PackageImpl theWcs100Package = (Wcs100PackageImpl)(EPackage.Registry.INSTANCE.getEPackage(Wcs100Package.eNS_URI) instanceof Wcs100PackageImpl ? EPackage.Registry.INSTANCE.getEPackage(Wcs100Package.eNS_URI) : Wcs100Package.eINSTANCE);
	 ...
	 * @generated
	 */
	public EAttribute getAbstractGMLType_MetaDataPropertyGroup() {
		return (EAttribute)abstractGMLTypeEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getAbstractGMLType_Name() {
		return (EReference)abstractGMLTypeEClass.getEStructuralFeatures().get(3);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(abstractGMLTypeEClass, ABSTRACT_GML_TYPE__META_DATA_PROPERTY_GROUP);
		...
		createEReference(gridTypeEClass, GRID_TYPE__LIMITS);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getAbstractGMLType_MetaDataPropertyGroup(), ecorePackage.getEFeatureMapEntry(), "metaDataPropertyGroup", null, 0, -1, AbstractGMLType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAbstractMetaDataType_Mixed(), ecorePackage.getEFeatureMapEntry(), "mixed", null, 0, -1, AbstractMetaDataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getBoundingShapeType_EnvelopeGroup(), ecorePackage.getEFeatureMapEntry(), "envelopeGroup", null, 1, 1, BoundingShapeType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDocumentRoot_Object(), ecorePackage.getEObject(), null, "object", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGridType_Limits(), this.getGridLimitsType(), null, "limits", null, 1, 1, GridType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGridType_AxisName(), theXMLTypePackage.getString(), "axisName", null, 1, -1, GridType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMetaDataPropertyType_MetaDataGroup(), ecorePackage.getEFeatureMapEntry(), "metaDataGroup", null, 0, 1, MetaDataPropertyType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMetaDataPropertyType_Actuate(), theXlinkPackage.getActuateType(), "actuate", null, 0, 1, MetaDataPropertyType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMetaDataPropertyType_Show(), theXlinkPackage.getShowType(), "show", null, 0, 1, MetaDataPropertyType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRectifiedGridType_OffsetVector(), this.getVectorType(), null, "offsetVector", null, 1, -1, RectifiedGridType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(referenceTypeEClass, ReferenceType.class, "ReferenceType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getReferenceType_Actuate(), theXlinkPackage.getActuateType(), "actuate", null, 0, 1, ReferenceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getReferenceType_Show(), theXlinkPackage.getShowType(), "show", null, 0, 1, ReferenceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getStringOrRefType_Actuate(), theXlinkPackage.getActuateType(), "actuate", null, 0, 1, StringOrRefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getStringOrRefType_Show(), theXlinkPackage.getShowType(), "show", null, 0, 1, StringOrRefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTimePositionType_IndeterminatePosition(), this.getTimeIndeterminateValueType(), "indeterminatePosition", null, 0, 1, TimePositionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(timeIndeterminateValueTypeEEnum, TimeIndeterminateValueType.AFTER);
		addEEnumLiteral(timeIndeterminateValueTypeEEnum, TimeIndeterminateValueType.BEFORE);
		addEEnumLiteral(timeIndeterminateValueTypeEEnum, TimeIndeterminateValueType.NOW);
		addEEnumLiteral(timeIndeterminateValueTypeEEnum, TimeIndeterminateValueType.UNKNOWN);
	...
	protected void createNullAnnotations() {
		...
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
			 "appinfo", "gml4wcs.xsd v1.0.0 2003-07-29"
		   });																																																																																																																																																																																																	
	}
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (getAbstractGMLType_MetaDataPropertyGroup(), 
		   source, 
		   new String[] {
			 "kind", "group",
			 "name", "metaDataProperty:group",
		...
		addAnnotation
		  (getRectifiedGridType_OffsetVector(), 
		   source, 
		   new String[] {
			 "kind", "element",
			 "name", "offsetVector",
