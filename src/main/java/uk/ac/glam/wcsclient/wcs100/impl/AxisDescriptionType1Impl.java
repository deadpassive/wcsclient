 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.AxisDescriptionType1Impl#getAxisDescription <em>Axis Description</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AxisDescriptionType1Impl extends EObjectImpl implements AxisDescriptionType1 {
	...
	protected EClass eStaticClass() {
		return Wcs100Package.Literals.AXIS_DESCRIPTION_TYPE1;
	}
	...
	public NotificationChain basicSetAxisDescription(AxisDescriptionType newAxisDescription, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Wcs100Package.AXIS_DESCRIPTION_TYPE1__AXIS_DESCRIPTION, oldAxisDescription, newAxisDescription);
	...
	public void setAxisDescription(AxisDescriptionType newAxisDescription) {
		if (newAxisDescription != axisDescription) {
			...
			if (axisDescription != null)
				msgs = ((InternalEObject)axisDescription).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.AXIS_DESCRIPTION_TYPE1__AXIS_DESCRIPTION, null, msgs);
			if (newAxisDescription != null)
				msgs = ((InternalEObject)newAxisDescription).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.AXIS_DESCRIPTION_TYPE1__AXIS_DESCRIPTION, null, msgs);
			msgs = basicSetAxisDescription(newAxisDescription, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.AXIS_DESCRIPTION_TYPE1__AXIS_DESCRIPTION, newAxisDescription, newAxisDescription));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Wcs100Package.AXIS_DESCRIPTION_TYPE1__AXIS_DESCRIPTION:
