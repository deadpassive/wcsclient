 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.TimePeriodTypeImpl#getBeginPosition <em>Begin Position</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.TimePeriodTypeImpl#getEndPosition <em>End Position</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.TimePeriodTypeImpl#getTimeResolution <em>Time Resolution</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.TimePeriodTypeImpl#getFrame <em>Frame</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TimePeriodTypeImpl extends EObjectImpl implements TimePeriodType {
	...
	protected EClass eStaticClass() {
		return Wcs100Package.Literals.TIME_PERIOD_TYPE;
	}
	...
	public NotificationChain basicSetBeginPosition(TimePositionType newBeginPosition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Wcs100Package.TIME_PERIOD_TYPE__BEGIN_POSITION, oldBeginPosition, newBeginPosition);
	...
	public void setBeginPosition(TimePositionType newBeginPosition) {
		if (newBeginPosition != beginPosition) {
			...
			if (beginPosition != null)
				msgs = ((InternalEObject)beginPosition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.TIME_PERIOD_TYPE__BEGIN_POSITION, null, msgs);
			if (newBeginPosition != null)
				msgs = ((InternalEObject)newBeginPosition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.TIME_PERIOD_TYPE__BEGIN_POSITION, null, msgs);
			msgs = basicSetBeginPosition(newBeginPosition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.TIME_PERIOD_TYPE__BEGIN_POSITION, newBeginPosition, newBeginPosition));
	}
	...
	public NotificationChain basicSetEndPosition(TimePositionType newEndPosition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Wcs100Package.TIME_PERIOD_TYPE__END_POSITION, oldEndPosition, newEndPosition);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEndPosition(TimePositionType newEndPosition) {
		if (newEndPosition != endPosition) {
			NotificationChain msgs = null;
			if (endPosition != null)
				msgs = ((InternalEObject)endPosition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.TIME_PERIOD_TYPE__END_POSITION, null, msgs);
			if (newEndPosition != null)
				msgs = ((InternalEObject)newEndPosition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.TIME_PERIOD_TYPE__END_POSITION, null, msgs);
			msgs = basicSetEndPosition(newEndPosition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.TIME_PERIOD_TYPE__END_POSITION, newEndPosition, newEndPosition));
	}
	...
	public void setTimeResolution(Object newTimeResolution) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.TIME_PERIOD_TYPE__TIME_RESOLUTION, oldTimeResolution, timeResolution));
	}
	...
	public void setFrame(String newFrame) {
		...
		frameESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.TIME_PERIOD_TYPE__FRAME, oldFrame, frame, !oldFrameESet));
	}
	...
	public void unsetFrame() {
		...
		frameESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Wcs100Package.TIME_PERIOD_TYPE__FRAME, oldFrame, FRAME_EDEFAULT, oldFrameESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Wcs100Package.TIME_PERIOD_TYPE__BEGIN_POSITION:
				return basicSetBeginPosition(null, msgs);
			case Wcs100Package.TIME_PERIOD_TYPE__END_POSITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Wcs100Package.TIME_PERIOD_TYPE__TIME_RESOLUTION:
				return getTimeResolution();
			case Wcs100Package.TIME_PERIOD_TYPE__FRAME:
				return getFrame();
		}
