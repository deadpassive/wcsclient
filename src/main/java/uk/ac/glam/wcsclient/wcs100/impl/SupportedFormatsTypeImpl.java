 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.SupportedFormatsTypeImpl#getFormats <em>Formats</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.SupportedFormatsTypeImpl#getNativeFormat <em>Native Format</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SupportedFormatsTypeImpl extends EObjectImpl implements SupportedFormatsType {
	 ...
	 * @ordered
	 */
	protected EList<CodeListType> formats;
	...
	protected EClass eStaticClass() {
		return Wcs100Package.Literals.SUPPORTED_FORMATS_TYPE;
	}
	 ...
	 * @generated
	 */
	public EList<CodeListType> getFormats() {
		if (formats == null) {
			formats = new EObjectContainmentEList<CodeListType>(CodeListType.class, this, Wcs100Package.SUPPORTED_FORMATS_TYPE__FORMATS);
		}
		return formats;
	}
	...
	public void setNativeFormat(String newNativeFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.SUPPORTED_FORMATS_TYPE__NATIVE_FORMAT, oldNativeFormat, nativeFormat));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Wcs100Package.SUPPORTED_FORMATS_TYPE__FORMATS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Wcs100Package.SUPPORTED_FORMATS_TYPE__FORMATS:
				return getFormats();
			case Wcs100Package.SUPPORTED_FORMATS_TYPE__NATIVE_FORMAT:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Wcs100Package.SUPPORTED_FORMATS_TYPE__FORMATS:
				getFormats().clear();
				getFormats().addAll((Collection<? extends CodeListType>)newValue);
				return;
			case Wcs100Package.SUPPORTED_FORMATS_TYPE__NATIVE_FORMAT:
