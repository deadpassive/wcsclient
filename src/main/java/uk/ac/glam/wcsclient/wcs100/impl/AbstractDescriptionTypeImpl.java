 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.AbstractDescriptionTypeImpl#getDescription1 <em>Description1</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.AbstractDescriptionTypeImpl#getName1 <em>Name1</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.AbstractDescriptionTypeImpl#getLabel <em>Label</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class AbstractDescriptionTypeImpl extends AbstractDescriptionBaseTypeImpl implements AbstractDescriptionType {
	...
	protected EClass eStaticClass() {
		return Wcs100Package.Literals.ABSTRACT_DESCRIPTION_TYPE;
	}
	...
	public void setDescription1(String newDescription1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.ABSTRACT_DESCRIPTION_TYPE__DESCRIPTION1, oldDescription1, description1));
	}
	...
	public void setName1(String newName1) {
		...
		name1 = newName1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.ABSTRACT_DESCRIPTION_TYPE__NAME1, oldName1, name1));
	}
	...
	public void setLabel(String newLabel) {
		...
		label = newLabel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.ABSTRACT_DESCRIPTION_TYPE__LABEL, oldLabel, label));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Wcs100Package.ABSTRACT_DESCRIPTION_TYPE__DESCRIPTION1:
				return getDescription1();
			case Wcs100Package.ABSTRACT_DESCRIPTION_TYPE__NAME1:
				return getName1();
			case Wcs100Package.ABSTRACT_DESCRIPTION_TYPE__LABEL:
				return getLabel();
		}
