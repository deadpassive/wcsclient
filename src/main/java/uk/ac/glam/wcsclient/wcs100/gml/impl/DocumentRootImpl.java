 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getGeometricPrimitive <em>Geometric Primitive</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getGeometry <em>Geometry</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getGML <em>GML</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getObject <em>Object</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getMetaData <em>Meta Data</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getRing <em>Ring</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getSurface <em>Surface</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getBoundedBy <em>Bounded By</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getEnvelope <em>Envelope</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getEnvelopeWithTimePeriod <em>Envelope With Time Period</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getExterior <em>Exterior</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getGrid <em>Grid</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getInterior <em>Interior</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getLinearRing <em>Linear Ring</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getMetaDataProperty <em>Meta Data Property</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getName <em>Name</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getPolygon <em>Polygon</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getPos <em>Pos</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getRectifiedGrid <em>Rectified Grid</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getTimePosition <em>Time Position</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getId <em>Id</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.gml.impl.DocumentRootImpl#getRemoteSchema <em>Remote Schema</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
