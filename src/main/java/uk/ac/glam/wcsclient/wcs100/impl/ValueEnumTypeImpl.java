 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.ValueEnumTypeImpl#getSemantic <em>Semantic</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.ValueEnumTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ValueEnumTypeImpl extends ValueEnumBaseTypeImpl implements ValueEnumType {
	...
	protected EClass eStaticClass() {
		return Wcs100Package.Literals.VALUE_ENUM_TYPE;
	}
	...
	public void setSemantic(String newSemantic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.VALUE_ENUM_TYPE__SEMANTIC, oldSemantic, semantic));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.VALUE_ENUM_TYPE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Wcs100Package.VALUE_ENUM_TYPE__SEMANTIC:
				return getSemantic();
			case Wcs100Package.VALUE_ENUM_TYPE__TYPE:
				return getType();
		}
