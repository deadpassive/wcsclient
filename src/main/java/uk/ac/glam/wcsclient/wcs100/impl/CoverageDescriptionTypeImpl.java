 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.CoverageDescriptionTypeImpl#getCoverageOffering <em>Coverage Offering</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.CoverageDescriptionTypeImpl#getUpdateSequence <em>Update Sequence</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.CoverageDescriptionTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CoverageDescriptionTypeImpl extends EObjectImpl implements CoverageDescriptionType {
	 ...
	 * @ordered
	 */
	protected EList<CoverageOfferingType> coverageOffering;
	...
	protected EClass eStaticClass() {
		return Wcs100Package.Literals.COVERAGE_DESCRIPTION_TYPE;
	}
	 ...
	 * @generated
	 */
	public EList<CoverageOfferingType> getCoverageOffering() {
		if (coverageOffering == null) {
			coverageOffering = new EObjectContainmentEList<CoverageOfferingType>(CoverageOfferingType.class, this, Wcs100Package.COVERAGE_DESCRIPTION_TYPE__COVERAGE_OFFERING);
		}
	...
	public void setUpdateSequence(String newUpdateSequence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.COVERAGE_DESCRIPTION_TYPE__UPDATE_SEQUENCE, oldUpdateSequence, updateSequence));
	}
	...
	public void setVersion(String newVersion) {
		...
		versionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.COVERAGE_DESCRIPTION_TYPE__VERSION, oldVersion, version, !oldVersionESet));
	}
	...
	public void unsetVersion() {
		...
		versionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Wcs100Package.COVERAGE_DESCRIPTION_TYPE__VERSION, oldVersion, VERSION_EDEFAULT, oldVersionESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Wcs100Package.COVERAGE_DESCRIPTION_TYPE__COVERAGE_OFFERING:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Wcs100Package.COVERAGE_DESCRIPTION_TYPE__UPDATE_SEQUENCE:
				return getUpdateSequence();
			case Wcs100Package.COVERAGE_DESCRIPTION_TYPE__VERSION:
				return getVersion();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Wcs100Package.COVERAGE_DESCRIPTION_TYPE__COVERAGE_OFFERING:
				...
				getCoverageOffering().addAll((Collection<? extends CoverageOfferingType>)newValue);
				return;
			case Wcs100Package.COVERAGE_DESCRIPTION_TYPE__UPDATE_SEQUENCE:
