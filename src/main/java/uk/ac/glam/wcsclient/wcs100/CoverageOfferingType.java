 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.CoverageOfferingType#getDomainSet <em>Domain Set</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.CoverageOfferingType#getRangeSet <em>Range Set</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.CoverageOfferingType#getSupportedCRSs <em>Supported CR Ss</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.CoverageOfferingType#getSupportedFormats <em>Supported Formats</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.CoverageOfferingType#getSupportedInterpolations <em>Supported Interpolations</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getCoverageOfferingType()
...
public interface CoverageOfferingType extends CoverageOfferingBriefType {
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getCoverageOfferingType_DomainSet()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs100.CoverageOfferingType#getDomainSet <em>Domain Set</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getCoverageOfferingType_RangeSet()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs100.CoverageOfferingType#getRangeSet <em>Range Set</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getCoverageOfferingType_SupportedCRSs()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs100.CoverageOfferingType#getSupportedCRSs <em>Supported CR Ss</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getCoverageOfferingType_SupportedFormats()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs100.CoverageOfferingType#getSupportedFormats <em>Supported Formats</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getCoverageOfferingType_SupportedInterpolations()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs100.CoverageOfferingType#getSupportedInterpolations <em>Supported Interpolations</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
