 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.DomainSubsetTypeImpl#getSpatialSubset <em>Spatial Subset</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.DomainSubsetTypeImpl#getTemporalSubset <em>Temporal Subset</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.DomainSubsetTypeImpl#getTemporalSubset1 <em>Temporal Subset1</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DomainSubsetTypeImpl extends EObjectImpl implements DomainSubsetType {
	...
	protected EClass eStaticClass() {
		return Wcs100Package.Literals.DOMAIN_SUBSET_TYPE;
	}
	...
	public NotificationChain basicSetSpatialSubset(SpatialSubsetType newSpatialSubset, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Wcs100Package.DOMAIN_SUBSET_TYPE__SPATIAL_SUBSET, oldSpatialSubset, newSpatialSubset);
	...
	public void setSpatialSubset(SpatialSubsetType newSpatialSubset) {
		if (newSpatialSubset != spatialSubset) {
			...
			if (spatialSubset != null)
				msgs = ((InternalEObject)spatialSubset).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.DOMAIN_SUBSET_TYPE__SPATIAL_SUBSET, null, msgs);
			if (newSpatialSubset != null)
				msgs = ((InternalEObject)newSpatialSubset).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.DOMAIN_SUBSET_TYPE__SPATIAL_SUBSET, null, msgs);
			msgs = basicSetSpatialSubset(newSpatialSubset, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.DOMAIN_SUBSET_TYPE__SPATIAL_SUBSET, newSpatialSubset, newSpatialSubset));
	}
	...
	public NotificationChain basicSetTemporalSubset(TimeSequenceType newTemporalSubset, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Wcs100Package.DOMAIN_SUBSET_TYPE__TEMPORAL_SUBSET, oldTemporalSubset, newTemporalSubset);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTemporalSubset(TimeSequenceType newTemporalSubset) {
		if (newTemporalSubset != temporalSubset) {
			...
			if (temporalSubset != null)
				msgs = ((InternalEObject)temporalSubset).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.DOMAIN_SUBSET_TYPE__TEMPORAL_SUBSET, null, msgs);
			if (newTemporalSubset != null)
				msgs = ((InternalEObject)newTemporalSubset).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.DOMAIN_SUBSET_TYPE__TEMPORAL_SUBSET, null, msgs);
			msgs = basicSetTemporalSubset(newTemporalSubset, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.DOMAIN_SUBSET_TYPE__TEMPORAL_SUBSET, newTemporalSubset, newTemporalSubset));
	}
	...
	public NotificationChain basicSetTemporalSubset1(TimeSequenceType newTemporalSubset1, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Wcs100Package.DOMAIN_SUBSET_TYPE__TEMPORAL_SUBSET1, oldTemporalSubset1, newTemporalSubset1);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTemporalSubset1(TimeSequenceType newTemporalSubset1) {
		if (newTemporalSubset1 != temporalSubset1) {
			...
			if (temporalSubset1 != null)
				msgs = ((InternalEObject)temporalSubset1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.DOMAIN_SUBSET_TYPE__TEMPORAL_SUBSET1, null, msgs);
			if (newTemporalSubset1 != null)
				msgs = ((InternalEObject)newTemporalSubset1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.DOMAIN_SUBSET_TYPE__TEMPORAL_SUBSET1, null, msgs);
			msgs = basicSetTemporalSubset1(newTemporalSubset1, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.DOMAIN_SUBSET_TYPE__TEMPORAL_SUBSET1, newTemporalSubset1, newTemporalSubset1));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Wcs100Package.DOMAIN_SUBSET_TYPE__SPATIAL_SUBSET:
				return basicSetSpatialSubset(null, msgs);
			case Wcs100Package.DOMAIN_SUBSET_TYPE__TEMPORAL_SUBSET:
				return basicSetTemporalSubset(null, msgs);
			case Wcs100Package.DOMAIN_SUBSET_TYPE__TEMPORAL_SUBSET1:
