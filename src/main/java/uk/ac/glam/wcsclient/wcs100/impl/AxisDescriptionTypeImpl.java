 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.AxisDescriptionTypeImpl#getValues <em>Values</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.AxisDescriptionTypeImpl#getRefSys <em>Ref Sys</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.AxisDescriptionTypeImpl#getRefSysLabel <em>Ref Sys Label</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.AxisDescriptionTypeImpl#getSemantic <em>Semantic</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AxisDescriptionTypeImpl extends AbstractDescriptionTypeImpl implements AxisDescriptionType {
	...
	protected EClass eStaticClass() {
		return Wcs100Package.Literals.AXIS_DESCRIPTION_TYPE;
	}
	...
	public NotificationChain basicSetValues(ValuesType newValues, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Wcs100Package.AXIS_DESCRIPTION_TYPE__VALUES, oldValues, newValues);
	...
	public void setValues(ValuesType newValues) {
		if (newValues != values) {
			...
			if (values != null)
				msgs = ((InternalEObject)values).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.AXIS_DESCRIPTION_TYPE__VALUES, null, msgs);
			if (newValues != null)
				msgs = ((InternalEObject)newValues).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.AXIS_DESCRIPTION_TYPE__VALUES, null, msgs);
			msgs = basicSetValues(newValues, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.AXIS_DESCRIPTION_TYPE__VALUES, newValues, newValues));
	}
	...
	public void setRefSys(String newRefSys) {
		...
		refSys = newRefSys;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.AXIS_DESCRIPTION_TYPE__REF_SYS, oldRefSys, refSys));
	}
	...
	public void setRefSysLabel(String newRefSysLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.AXIS_DESCRIPTION_TYPE__REF_SYS_LABEL, oldRefSysLabel, refSysLabel));
	}
	...
	public void setSemantic(String newSemantic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.AXIS_DESCRIPTION_TYPE__SEMANTIC, oldSemantic, semantic));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Wcs100Package.AXIS_DESCRIPTION_TYPE__VALUES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Wcs100Package.AXIS_DESCRIPTION_TYPE__VALUES:
				return getValues();
			case Wcs100Package.AXIS_DESCRIPTION_TYPE__REF_SYS:
				return getRefSys();
			case Wcs100Package.AXIS_DESCRIPTION_TYPE__REF_SYS_LABEL:
				return getRefSysLabel();
			case Wcs100Package.AXIS_DESCRIPTION_TYPE__SEMANTIC:
				return getSemantic();
		}
