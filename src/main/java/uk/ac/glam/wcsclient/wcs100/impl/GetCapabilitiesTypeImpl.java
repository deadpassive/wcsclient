 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.GetCapabilitiesTypeImpl#getSection <em>Section</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.GetCapabilitiesTypeImpl#getService <em>Service</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.GetCapabilitiesTypeImpl#getUpdateSequence <em>Update Sequence</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.GetCapabilitiesTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GetCapabilitiesTypeImpl extends EObjectImpl implements GetCapabilitiesType {
	 ...
	 * @ordered
	 */
	protected static final CapabilitiesSectionType SECTION_EDEFAULT = CapabilitiesSectionType._;
	...
	protected EClass eStaticClass() {
		return Wcs100Package.Literals.GET_CAPABILITIES_TYPE;
	}
	...
	public void setSection(CapabilitiesSectionType newSection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.GET_CAPABILITIES_TYPE__SECTION, oldSection, section, !oldSectionESet));
	}
	...
	public void unsetSection() {
		...
		sectionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Wcs100Package.GET_CAPABILITIES_TYPE__SECTION, oldSection, SECTION_EDEFAULT, oldSectionESet));
	}
	...
	public void setService(String newService) {
		...
		serviceESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.GET_CAPABILITIES_TYPE__SERVICE, oldService, service, !oldServiceESet));
	}
	...
	public void unsetService() {
		...
		serviceESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Wcs100Package.GET_CAPABILITIES_TYPE__SERVICE, oldService, SERVICE_EDEFAULT, oldServiceESet));
	}
	...
	public void setUpdateSequence(String newUpdateSequence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.GET_CAPABILITIES_TYPE__UPDATE_SEQUENCE, oldUpdateSequence, updateSequence));
	}
	...
	public void setVersion(String newVersion) {
		...
		versionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.GET_CAPABILITIES_TYPE__VERSION, oldVersion, version, !oldVersionESet));
	}
	...
	public void unsetVersion() {
		...
		versionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Wcs100Package.GET_CAPABILITIES_TYPE__VERSION, oldVersion, VERSION_EDEFAULT, oldVersionESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Wcs100Package.GET_CAPABILITIES_TYPE__SECTION:
				return getSection();
			case Wcs100Package.GET_CAPABILITIES_TYPE__SERVICE:
				return getService();
			case Wcs100Package.GET_CAPABILITIES_TYPE__UPDATE_SEQUENCE:
				return getUpdateSequence();
			case Wcs100Package.GET_CAPABILITIES_TYPE__VERSION:
				return getVersion();
		}
