 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.ResponsiblePartyTypeImpl#getIndividualName <em>Individual Name</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.ResponsiblePartyTypeImpl#getOrganisationName <em>Organisation Name</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.ResponsiblePartyTypeImpl#getOrganisationName1 <em>Organisation Name1</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.ResponsiblePartyTypeImpl#getPositionName <em>Position Name</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.ResponsiblePartyTypeImpl#getContactInfo <em>Contact Info</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResponsiblePartyTypeImpl extends EObjectImpl implements ResponsiblePartyType {
	...
	protected EClass eStaticClass() {
		return Wcs100Package.Literals.RESPONSIBLE_PARTY_TYPE;
	}
	...
	public void setIndividualName(String newIndividualName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.RESPONSIBLE_PARTY_TYPE__INDIVIDUAL_NAME, oldIndividualName, individualName));
	}
	...
	public void setOrganisationName(String newOrganisationName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.RESPONSIBLE_PARTY_TYPE__ORGANISATION_NAME, oldOrganisationName, organisationName));
	}
	...
	public void setOrganisationName1(String newOrganisationName1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.RESPONSIBLE_PARTY_TYPE__ORGANISATION_NAME1, oldOrganisationName1, organisationName1));
	}
	...
	public void setPositionName(String newPositionName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.RESPONSIBLE_PARTY_TYPE__POSITION_NAME, oldPositionName, positionName));
	}
	...
	public NotificationChain basicSetContactInfo(ContactType newContactInfo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Wcs100Package.RESPONSIBLE_PARTY_TYPE__CONTACT_INFO, oldContactInfo, newContactInfo);
	...
	public void setContactInfo(ContactType newContactInfo) {
		if (newContactInfo != contactInfo) {
			...
			if (contactInfo != null)
				msgs = ((InternalEObject)contactInfo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.RESPONSIBLE_PARTY_TYPE__CONTACT_INFO, null, msgs);
			if (newContactInfo != null)
				msgs = ((InternalEObject)newContactInfo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.RESPONSIBLE_PARTY_TYPE__CONTACT_INFO, null, msgs);
			msgs = basicSetContactInfo(newContactInfo, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.RESPONSIBLE_PARTY_TYPE__CONTACT_INFO, newContactInfo, newContactInfo));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Wcs100Package.RESPONSIBLE_PARTY_TYPE__CONTACT_INFO:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Wcs100Package.RESPONSIBLE_PARTY_TYPE__INDIVIDUAL_NAME:
				return getIndividualName();
			case Wcs100Package.RESPONSIBLE_PARTY_TYPE__ORGANISATION_NAME:
				return getOrganisationName();
			case Wcs100Package.RESPONSIBLE_PARTY_TYPE__ORGANISATION_NAME1:
				return getOrganisationName1();
			case Wcs100Package.RESPONSIBLE_PARTY_TYPE__POSITION_NAME:
