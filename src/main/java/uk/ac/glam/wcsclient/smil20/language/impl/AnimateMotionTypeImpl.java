...
import uk.ac.glam.wcsclient.smil20.impl.AnimateMotionPrototypeImpl;

import uk.ac.glam.wcsclient.smil20.language.AnimateMotionType;
 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getAlt <em>Alt</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getBegin <em>Begin</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getCalcMode <em>Calc Mode</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getDur <em>Dur</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getEnd <em>End</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getFill <em>Fill</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getFillDefault <em>Fill Default</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getLongdesc <em>Longdesc</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getMax <em>Max</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getMin <em>Min</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getRepeat <em>Repeat</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getRepeatCount <em>Repeat Count</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getRepeatDur <em>Repeat Dur</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getRestart <em>Restart</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getRestartDefault <em>Restart Default</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#isSkipContent <em>Skip Content</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getSyncBehavior <em>Sync Behavior</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getSyncBehaviorDefault <em>Sync Behavior Default</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getSyncTolerance <em>Sync Tolerance</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getSyncToleranceDefault <em>Sync Tolerance Default</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getTargetElement <em>Target Element</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateMotionTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
