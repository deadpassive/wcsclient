...
import uk.ac.glam.wcsclient.smil20.impl.AnimatePrototypeImpl;

import uk.ac.glam.wcsclient.smil20.language.AnimateType;
 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getAlt <em>Alt</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getBegin <em>Begin</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getCalcMode <em>Calc Mode</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getDur <em>Dur</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getEnd <em>End</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getFill <em>Fill</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getFillDefault <em>Fill Default</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getLongdesc <em>Longdesc</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getMax <em>Max</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getMin <em>Min</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getRepeat <em>Repeat</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getRepeatCount <em>Repeat Count</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getRepeatDur <em>Repeat Dur</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getRestart <em>Restart</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getRestartDefault <em>Restart Default</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#isSkipContent <em>Skip Content</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getSyncBehavior <em>Sync Behavior</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getSyncBehaviorDefault <em>Sync Behavior Default</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getSyncTolerance <em>Sync Tolerance</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getSyncToleranceDefault <em>Sync Tolerance Default</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getTargetElement <em>Target Element</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnimateTypeImpl extends AnimatePrototypeImpl implements AnimateType {
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, LanguagePackage.ANIMATE_TYPE__GROUP);
		}
		return group;
	}
	...
	public FeatureMap getAny() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(LanguagePackage.Literals.ANIMATE_TYPE__ANY);
	}
	...
	public void setAlt(String newAlt) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__ALT, oldAlt, alt));
	}
	...
	public void setBegin(String newBegin) {
		...
		begin = newBegin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__BEGIN, oldBegin, begin));
	}
	...
	public void setCalcMode(CalcModeType newCalcMode) {
		...
		calcModeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__CALC_MODE, oldCalcMode, calcMode, !oldCalcModeESet));
	}
	...
	public void unsetCalcMode() {
		...
		calcModeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LanguagePackage.ANIMATE_TYPE__CALC_MODE, oldCalcMode, CALC_MODE_EDEFAULT, oldCalcModeESet));
	}
	...
	public void setClass(String newClass) {
		...
		class_ = newClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__CLASS, oldClass, class_));
	}
	...
	public void setDur(String newDur) {
		...
		dur = newDur;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__DUR, oldDur, dur));
	}
	...
	public void setEnd(String newEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__END, oldEnd, end));
	}
	...
	public void setFill(FillTimingAttrsType newFill) {
		...
		fillESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__FILL, oldFill, fill, !oldFillESet));
	}
	...
	public void unsetFill() {
		...
		fillESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LanguagePackage.ANIMATE_TYPE__FILL, oldFill, FILL_EDEFAULT, oldFillESet));
	}
	...
	public void setFillDefault(FillDefaultType newFillDefault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__FILL_DEFAULT, oldFillDefault, fillDefault, !oldFillDefaultESet));
	}
	...
	public void unsetFillDefault() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LanguagePackage.ANIMATE_TYPE__FILL_DEFAULT, oldFillDefault, FILL_DEFAULT_EDEFAULT, oldFillDefaultESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__ID, oldId, id));
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__LANG, oldLang, lang));
	}
	...
	public void setLongdesc(String newLongdesc) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__LONGDESC, oldLongdesc, longdesc));
	}
	...
	public void setMax(String newMax) {
		...
		max = newMax;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__MAX, oldMax, max));
	}
	...
	public void setMin(String newMin) {
		...
		min = newMin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__MIN, oldMin, min));
	}
	...
	public void setRepeat(BigInteger newRepeat) {
		...
		repeat = newRepeat;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__REPEAT, oldRepeat, repeat));
	}
	...
	public void setRepeatCount(BigDecimal newRepeatCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__REPEAT_COUNT, oldRepeatCount, repeatCount));
	}
	...
	public void setRepeatDur(String newRepeatDur) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__REPEAT_DUR, oldRepeatDur, repeatDur));
	}
	...
	public void setRestart(RestartTimingType newRestart) {
		...
		restartESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__RESTART, oldRestart, restart, !oldRestartESet));
	}
	...
	public void unsetRestart() {
		...
		restartESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LanguagePackage.ANIMATE_TYPE__RESTART, oldRestart, RESTART_EDEFAULT, oldRestartESet));
	}
	...
	public void setRestartDefault(RestartDefaultType newRestartDefault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__RESTART_DEFAULT, oldRestartDefault, restartDefault, !oldRestartDefaultESet));
	}
	...
	public void unsetRestartDefault() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LanguagePackage.ANIMATE_TYPE__RESTART_DEFAULT, oldRestartDefault, RESTART_DEFAULT_EDEFAULT, oldRestartDefaultESet));
	}
	...
	public void setSkipContent(boolean newSkipContent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__SKIP_CONTENT, oldSkipContent, skipContent, !oldSkipContentESet));
	}
	...
	public void unsetSkipContent() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LanguagePackage.ANIMATE_TYPE__SKIP_CONTENT, oldSkipContent, SKIP_CONTENT_EDEFAULT, oldSkipContentESet));
	}
	...
	public void setSyncBehavior(SyncBehaviorType newSyncBehavior) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__SYNC_BEHAVIOR, oldSyncBehavior, syncBehavior, !oldSyncBehaviorESet));
	}
	...
	public void unsetSyncBehavior() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LanguagePackage.ANIMATE_TYPE__SYNC_BEHAVIOR, oldSyncBehavior, SYNC_BEHAVIOR_EDEFAULT, oldSyncBehaviorESet));
	}
	...
	public void setSyncBehaviorDefault(SyncBehaviorDefaultType newSyncBehaviorDefault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__SYNC_BEHAVIOR_DEFAULT, oldSyncBehaviorDefault, syncBehaviorDefault, !oldSyncBehaviorDefaultESet));
	}
	...
	public void unsetSyncBehaviorDefault() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LanguagePackage.ANIMATE_TYPE__SYNC_BEHAVIOR_DEFAULT, oldSyncBehaviorDefault, SYNC_BEHAVIOR_DEFAULT_EDEFAULT, oldSyncBehaviorDefaultESet));
	}
	...
	public void setSyncTolerance(String newSyncTolerance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__SYNC_TOLERANCE, oldSyncTolerance, syncTolerance));
	}
	...
	public void setSyncToleranceDefault(String newSyncToleranceDefault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__SYNC_TOLERANCE_DEFAULT, oldSyncToleranceDefault, syncToleranceDefault, !oldSyncToleranceDefaultESet));
	}
	...
	public void unsetSyncToleranceDefault() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LanguagePackage.ANIMATE_TYPE__SYNC_TOLERANCE_DEFAULT, oldSyncToleranceDefault, SYNC_TOLERANCE_DEFAULT_EDEFAULT, oldSyncToleranceDefaultESet));
	}
	...
	public void setTargetElement(String newTargetElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_TYPE__TARGET_ELEMENT, oldTargetElement, targetElement));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, LanguagePackage.ANIMATE_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
