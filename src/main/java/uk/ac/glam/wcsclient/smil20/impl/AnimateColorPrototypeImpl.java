 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.impl.AnimateColorPrototypeImpl#getAccumulate <em>Accumulate</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.impl.AnimateColorPrototypeImpl#getAdditive <em>Additive</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.impl.AnimateColorPrototypeImpl#getAttributeName <em>Attribute Name</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.impl.AnimateColorPrototypeImpl#getAttributeType <em>Attribute Type</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.impl.AnimateColorPrototypeImpl#getBy <em>By</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.impl.AnimateColorPrototypeImpl#getFrom <em>From</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.impl.AnimateColorPrototypeImpl#getTo <em>To</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.impl.AnimateColorPrototypeImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AnimateColorPrototypeImpl extends EObjectImpl implements AnimateColorPrototype {
	/**
