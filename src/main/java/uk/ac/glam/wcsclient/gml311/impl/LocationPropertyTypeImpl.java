 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.LocationPropertyTypeImpl#getGeometryGroup <em>Geometry Group</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.LocationPropertyTypeImpl#getGeometry <em>Geometry</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.LocationPropertyTypeImpl#getLocationKeyWord <em>Location Key Word</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.LocationPropertyTypeImpl#getLocationString <em>Location String</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.LocationPropertyTypeImpl#getNull <em>Null</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.LocationPropertyTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.LocationPropertyTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.LocationPropertyTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.LocationPropertyTypeImpl#getRemoteSchema <em>Remote Schema</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.LocationPropertyTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.LocationPropertyTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.LocationPropertyTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.LocationPropertyTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LocationPropertyTypeImpl extends EObjectImpl implements LocationPropertyType {
	/**
