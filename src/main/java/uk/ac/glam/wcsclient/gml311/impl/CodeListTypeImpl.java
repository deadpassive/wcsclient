...
import uk.ac.glam.wcsclient.gml311.CodeListType;
 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.CodeListTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.CodeListTypeImpl#getCodeSpace <em>Code Space</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CodeListTypeImpl extends EObjectImpl implements CodeListType {
	...
	protected EClass eStaticClass() {
		return Gml311Package.eINSTANCE.getCodeListType();
	}
	...
	public void setValue(List<String> newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.CODE_LIST_TYPE__VALUE, oldValue, value));
	}
	...
	public void setCodeSpace(String newCodeSpace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.CODE_LIST_TYPE__CODE_SPACE, oldCodeSpace, codeSpace));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Gml311Package.CODE_LIST_TYPE__VALUE:
				return getValue();
			case Gml311Package.CODE_LIST_TYPE__CODE_SPACE:
				return getCodeSpace();
		}
