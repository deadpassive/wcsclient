 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.TopoPointType#getDirectedNode <em>Directed Node</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getTopoPointType()
...
public interface TopoPointType extends AbstractTopologyType {
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getTopoPointType_DirectedNode()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.gml311.TopoPointType#getDirectedNode <em>Directed Node</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
