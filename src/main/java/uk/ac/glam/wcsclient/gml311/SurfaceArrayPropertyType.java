 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.SurfaceArrayPropertyType#getSurfaceGroup <em>Surface Group</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.SurfaceArrayPropertyType#getSurface <em>Surface</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getSurfaceArrayPropertyType()
...
public interface SurfaceArrayPropertyType extends EObject {
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getSurfaceArrayPropertyType_SurfaceGroup()
	 ...
	 * The list contents are of type {@link uk.ac.glam.wcsclient.gml311.AbstractSurfaceType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * The "_Surface" element is the abstract head of the substituition group for all (continuous) surface elements.
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getSurfaceArrayPropertyType_Surface()
