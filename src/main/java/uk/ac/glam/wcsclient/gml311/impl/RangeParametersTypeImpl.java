 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RangeParametersTypeImpl#isBoolean <em>Boolean</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RangeParametersTypeImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RangeParametersTypeImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RangeParametersTypeImpl#getCount <em>Count</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RangeParametersTypeImpl#getBooleanList <em>Boolean List</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RangeParametersTypeImpl#getCategoryList <em>Category List</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RangeParametersTypeImpl#getQuantityList <em>Quantity List</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RangeParametersTypeImpl#getCountList <em>Count List</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RangeParametersTypeImpl#getCategoryExtent <em>Category Extent</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RangeParametersTypeImpl#getQuantityExtent <em>Quantity Extent</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RangeParametersTypeImpl#getCountExtent <em>Count Extent</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RangeParametersTypeImpl#getCompositeValueGroup <em>Composite Value Group</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RangeParametersTypeImpl#getCompositeValue <em>Composite Value</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RangeParametersTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RangeParametersTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RangeParametersTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RangeParametersTypeImpl#getRemoteSchema <em>Remote Schema</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RangeParametersTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RangeParametersTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RangeParametersTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RangeParametersTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RangeParametersTypeImpl extends EObjectImpl implements RangeParametersType {
	/**
