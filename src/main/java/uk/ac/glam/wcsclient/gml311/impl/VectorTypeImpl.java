 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.VectorTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.VectorTypeImpl#getAxisLabels <em>Axis Labels</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.VectorTypeImpl#getSrsDimension <em>Srs Dimension</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.VectorTypeImpl#getSrsName <em>Srs Name</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.VectorTypeImpl#getUomLabels <em>Uom Labels</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VectorTypeImpl extends EObjectImpl implements VectorType {
	...
	protected EClass eStaticClass() {
		return Gml311Package.eINSTANCE.getVectorType();
	}
	...
	public void setValue(List<Double> newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.VECTOR_TYPE__VALUE, oldValue, value));
	}
	...
	public void setAxisLabels(List<String> newAxisLabels) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.VECTOR_TYPE__AXIS_LABELS, oldAxisLabels, axisLabels));
	}
	...
	public void setSrsDimension(BigInteger newSrsDimension) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.VECTOR_TYPE__SRS_DIMENSION, oldSrsDimension, srsDimension));
	}
	...
	public void setSrsName(String newSrsName) {
		...
		srsName = newSrsName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.VECTOR_TYPE__SRS_NAME, oldSrsName, srsName));
	}
	...
	public void setUomLabels(List<String> newUomLabels) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.VECTOR_TYPE__UOM_LABELS, oldUomLabels, uomLabels));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Gml311Package.VECTOR_TYPE__VALUE:
				return getValue();
			case Gml311Package.VECTOR_TYPE__AXIS_LABELS:
				return getAxisLabels();
			case Gml311Package.VECTOR_TYPE__SRS_DIMENSION:
				return getSrsDimension();
			case Gml311Package.VECTOR_TYPE__SRS_NAME:
				return getSrsName();
			case Gml311Package.VECTOR_TYPE__UOM_LABELS:
				return getUomLabels();
		}
