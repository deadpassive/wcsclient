 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.IsolatedPropertyTypeImpl#getNode <em>Node</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.IsolatedPropertyTypeImpl#getEdge <em>Edge</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.IsolatedPropertyTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.IsolatedPropertyTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.IsolatedPropertyTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.IsolatedPropertyTypeImpl#getRemoteSchema <em>Remote Schema</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.IsolatedPropertyTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.IsolatedPropertyTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.IsolatedPropertyTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.IsolatedPropertyTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IsolatedPropertyTypeImpl extends EObjectImpl implements IsolatedPropertyType {
	/**
