 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.DirectedFacePropertyTypeImpl#getFace <em>Face</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.DirectedFacePropertyTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.DirectedFacePropertyTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.DirectedFacePropertyTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.DirectedFacePropertyTypeImpl#getOrientation <em>Orientation</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.DirectedFacePropertyTypeImpl#getRemoteSchema <em>Remote Schema</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.DirectedFacePropertyTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.DirectedFacePropertyTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.DirectedFacePropertyTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.DirectedFacePropertyTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DirectedFacePropertyTypeImpl extends EObjectImpl implements DirectedFacePropertyType {
	/**
