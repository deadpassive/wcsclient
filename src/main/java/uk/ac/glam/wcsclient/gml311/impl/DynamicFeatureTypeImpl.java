...
import uk.ac.glam.wcsclient.gml311.DynamicFeatureType;
 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.DynamicFeatureTypeImpl#getValidTime <em>Valid Time</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.DynamicFeatureTypeImpl#getHistoryGroup <em>History Group</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.DynamicFeatureTypeImpl#getHistory <em>History</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.DynamicFeatureTypeImpl#getDataSource <em>Data Source</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DynamicFeatureTypeImpl extends AbstractFeatureTypeImpl implements DynamicFeatureType {
	...
	protected EClass eStaticClass() {
		return Gml311Package.eINSTANCE.getDynamicFeatureType();
	}
	...
	public NotificationChain basicSetValidTime(TimePrimitivePropertyType newValidTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Gml311Package.DYNAMIC_FEATURE_TYPE__VALID_TIME, oldValidTime, newValidTime);
	...
	public void setValidTime(TimePrimitivePropertyType newValidTime) {
		if (newValidTime != validTime) {
			...
			if (validTime != null)
				msgs = ((InternalEObject)validTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Gml311Package.DYNAMIC_FEATURE_TYPE__VALID_TIME, null, msgs);
			if (newValidTime != null)
				msgs = ((InternalEObject)newValidTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Gml311Package.DYNAMIC_FEATURE_TYPE__VALID_TIME, null, msgs);
			msgs = basicSetValidTime(newValidTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.DYNAMIC_FEATURE_TYPE__VALID_TIME, newValidTime, newValidTime));
	}
	...
	public NotificationChain basicSetHistory(HistoryPropertyType newHistory, NotificationChain msgs) {
		return ((FeatureMap.Internal)getHistoryGroup()).basicAdd(Gml311Package.eINSTANCE.getDynamicFeatureType_History(), newHistory, msgs);
	}
	...
	public NotificationChain basicSetDataSource(StringOrRefType newDataSource, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Gml311Package.DYNAMIC_FEATURE_TYPE__DATA_SOURCE, oldDataSource, newDataSource);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDataSource(StringOrRefType newDataSource) {
		if (newDataSource != dataSource) {
			NotificationChain msgs = null;
			if (dataSource != null)
				msgs = ((InternalEObject)dataSource).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Gml311Package.DYNAMIC_FEATURE_TYPE__DATA_SOURCE, null, msgs);
			if (newDataSource != null)
				msgs = ((InternalEObject)newDataSource).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Gml311Package.DYNAMIC_FEATURE_TYPE__DATA_SOURCE, null, msgs);
			msgs = basicSetDataSource(newDataSource, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.DYNAMIC_FEATURE_TYPE__DATA_SOURCE, newDataSource, newDataSource));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Gml311Package.DYNAMIC_FEATURE_TYPE__VALID_TIME:
				return basicSetValidTime(null, msgs);
			case Gml311Package.DYNAMIC_FEATURE_TYPE__HISTORY_GROUP:
				return ((InternalEList<?>)getHistoryGroup()).basicRemove(otherEnd, msgs);
			case Gml311Package.DYNAMIC_FEATURE_TYPE__HISTORY:
				return basicSetHistory(null, msgs);
			case Gml311Package.DYNAMIC_FEATURE_TYPE__DATA_SOURCE:
