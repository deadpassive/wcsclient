 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.DictionaryType#getGroup <em>Group</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.DictionaryType#getDictionaryEntryGroup <em>Dictionary Entry Group</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.DictionaryType#getDictionaryEntry <em>Dictionary Entry</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.DictionaryType#getIndirectEntry <em>Indirect Entry</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getDictionaryType()
...
public interface DictionaryType extends DefinitionType {
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getDictionaryType_Group()
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getDictionaryType_DictionaryEntryGroup()
	 ...
	 * The list contents are of type {@link uk.ac.glam.wcsclient.gml311.DictionaryEntryType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * An entry in this dictionary. The content of an entry can itself be a lower level dictionary or definition collection. This element follows the standard GML property model, so the value may be provided directly or by reference. Note that if the value is provided by reference, this definition does not carry a handle (gml:id) in this context, so does not allow external references to this specific entry in this context. When used in this way the referenced definition will usually be in a dictionary in the same XML document. 
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getDictionaryType_DictionaryEntry()
	 ...
	 * The list contents are of type {@link uk.ac.glam.wcsclient.gml311.IndirectEntryType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getDictionaryType_IndirectEntry()
	 * @model containment="true" transient="true" volatile="true" derived="true"
