 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.SolidArrayPropertyType#getGroup <em>Group</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.SolidArrayPropertyType#getSolidGroup <em>Solid Group</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.SolidArrayPropertyType#getSolid <em>Solid</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getSolidArrayPropertyType()
...
public interface SolidArrayPropertyType extends EObject {
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getSolidArrayPropertyType_Group()
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getSolidArrayPropertyType_SolidGroup()
	 ...
	 * The list contents are of type {@link uk.ac.glam.wcsclient.gml311.AbstractSolidType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * The "_Solid" element is the abstract head of the substituition group for all (continuous) solid elements.
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getSolidArrayPropertyType_Solid()
