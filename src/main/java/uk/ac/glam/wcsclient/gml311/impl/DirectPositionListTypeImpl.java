 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.DirectPositionListTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.DirectPositionListTypeImpl#getAxisLabels <em>Axis Labels</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.DirectPositionListTypeImpl#getCount <em>Count</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.DirectPositionListTypeImpl#getSrsDimension <em>Srs Dimension</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.DirectPositionListTypeImpl#getSrsName <em>Srs Name</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.DirectPositionListTypeImpl#getUomLabels <em>Uom Labels</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DirectPositionListTypeImpl extends EObjectImpl implements DirectPositionListType {
	...
	protected EClass eStaticClass() {
		return Gml311Package.eINSTANCE.getDirectPositionListType();
	}
	...
	public void setValue(List<Double> newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.DIRECT_POSITION_LIST_TYPE__VALUE, oldValue, value));
	}
	...
	public void setAxisLabels(List<String> newAxisLabels) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.DIRECT_POSITION_LIST_TYPE__AXIS_LABELS, oldAxisLabels, axisLabels));
	}
	...
	public void setCount(BigInteger newCount) {
		...
		count = newCount;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.DIRECT_POSITION_LIST_TYPE__COUNT, oldCount, count));
	}
	...
	public void setSrsDimension(BigInteger newSrsDimension) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.DIRECT_POSITION_LIST_TYPE__SRS_DIMENSION, oldSrsDimension, srsDimension));
	}
	...
	public void setSrsName(String newSrsName) {
		...
		srsName = newSrsName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.DIRECT_POSITION_LIST_TYPE__SRS_NAME, oldSrsName, srsName));
	}
	...
	public void setUomLabels(List<String> newUomLabels) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.DIRECT_POSITION_LIST_TYPE__UOM_LABELS, oldUomLabels, uomLabels));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Gml311Package.DIRECT_POSITION_LIST_TYPE__VALUE:
				return getValue();
			case Gml311Package.DIRECT_POSITION_LIST_TYPE__AXIS_LABELS:
				return getAxisLabels();
			case Gml311Package.DIRECT_POSITION_LIST_TYPE__COUNT:
				return getCount();
			case Gml311Package.DIRECT_POSITION_LIST_TYPE__SRS_DIMENSION:
				return getSrsDimension();
			case Gml311Package.DIRECT_POSITION_LIST_TYPE__SRS_NAME:
				return getSrsName();
			case Gml311Package.DIRECT_POSITION_LIST_TYPE__UOM_LABELS:
				return getUomLabels();
		}
