...
import uk.ac.glam.wcsclient.gml311.TimeIndeterminateValueType;
 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.TimePositionTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.TimePositionTypeImpl#getCalendarEraName <em>Calendar Era Name</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.TimePositionTypeImpl#getFrame <em>Frame</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.TimePositionTypeImpl#getIndeterminatePosition <em>Indeterminate Position</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TimePositionTypeImpl extends EObjectImpl implements TimePositionType {
	...
	public void setValue(Object newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.TIME_POSITION_TYPE__VALUE, oldValue, value));
	}
	...
	public void setCalendarEraName(String newCalendarEraName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.TIME_POSITION_TYPE__CALENDAR_ERA_NAME, oldCalendarEraName, calendarEraName));
	}
	...
	public void setFrame(String newFrame) {
		...
		frameESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.TIME_POSITION_TYPE__FRAME, oldFrame, frame, !oldFrameESet));
	}
	...
	public void unsetFrame() {
		...
		frameESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Gml311Package.TIME_POSITION_TYPE__FRAME, oldFrame, FRAME_EDEFAULT, oldFrameESet));
	}
	...
	public void setIndeterminatePosition(TimeIndeterminateValueType newIndeterminatePosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.TIME_POSITION_TYPE__INDETERMINATE_POSITION, oldIndeterminatePosition, indeterminatePosition, !oldIndeterminatePositionESet));
	}
	...
	public void unsetIndeterminatePosition() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Gml311Package.TIME_POSITION_TYPE__INDETERMINATE_POSITION, oldIndeterminatePosition, INDETERMINATE_POSITION_EDEFAULT, oldIndeterminatePositionESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Gml311Package.TIME_POSITION_TYPE__VALUE:
				return getValue();
			case Gml311Package.TIME_POSITION_TYPE__CALENDAR_ERA_NAME:
				return getCalendarEraName();
			case Gml311Package.TIME_POSITION_TYPE__FRAME:
				return getFrame();
			case Gml311Package.TIME_POSITION_TYPE__INDETERMINATE_POSITION:
