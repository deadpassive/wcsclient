...
import uk.ac.glam.wcsclient.gml311.SurfaceInterpolationType;
 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RectangleTypeImpl#getExteriorGroup <em>Exterior Group</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RectangleTypeImpl#getExterior <em>Exterior</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.RectangleTypeImpl#getInterpolation <em>Interpolation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RectangleTypeImpl extends AbstractSurfacePatchTypeImpl implements RectangleType {
	...
	protected EClass eStaticClass() {
		return Gml311Package.eINSTANCE.getRectangleType();
	}
	...
	public NotificationChain basicSetExterior(AbstractRingPropertyType newExterior, NotificationChain msgs) {
		return ((FeatureMap.Internal)getExteriorGroup()).basicAdd(Gml311Package.eINSTANCE.getRectangleType_Exterior(), newExterior, msgs);
	}
	...
	public void setInterpolation(SurfaceInterpolationType newInterpolation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.RECTANGLE_TYPE__INTERPOLATION, oldInterpolation, interpolation, !oldInterpolationESet));
	}
	...
	public void unsetInterpolation() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Gml311Package.RECTANGLE_TYPE__INTERPOLATION, oldInterpolation, INTERPOLATION_EDEFAULT, oldInterpolationESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Gml311Package.RECTANGLE_TYPE__EXTERIOR_GROUP:
