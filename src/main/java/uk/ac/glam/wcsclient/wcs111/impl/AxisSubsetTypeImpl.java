 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.AxisSubsetTypeImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.AxisSubsetTypeImpl#getKey <em>Key</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AxisSubsetTypeImpl extends EObjectImpl implements AxisSubsetType {
	...
	public EList<String> getKey() {
		if (key == null) {
			key = new EDataTypeEList<String>(String.class, this, Wcs111Package.AXIS_SUBSET_TYPE__KEY);
		}
		return key;
	}
