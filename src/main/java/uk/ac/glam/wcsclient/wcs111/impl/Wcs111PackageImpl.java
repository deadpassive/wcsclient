...
import uk.ac.glam.wcsclient.ows110.Ows110Factory;
import uk.ac.glam.wcsclient.ows110.Ows110Package;

import uk.ac.glam.wcsclient.ows110.impl.Ows110FactoryImpl;
...
import uk.ac.glam.wcsclient.wcs111.AxisSubsetType;
...
import uk.ac.glam.wcsclient.wcs111.DescribeCoverageType;
import uk.ac.glam.wcsclient.wcs111.DocumentRoot;
import uk.ac.glam.wcsclient.wcs111.DomainSubsetType;
import uk.ac.glam.wcsclient.wcs111.FieldSubsetType;
import uk.ac.glam.wcsclient.wcs111.FieldType;
import uk.ac.glam.wcsclient.wcs111.GetCapabilitiesType;
import uk.ac.glam.wcsclient.wcs111.GetCoverageType;
import uk.ac.glam.wcsclient.wcs111.GridCrsType;
import uk.ac.glam.wcsclient.wcs111.ImageCRSRefType;
import uk.ac.glam.wcsclient.wcs111.InterpolationMethodBaseType;
import uk.ac.glam.wcsclient.wcs111.InterpolationMethodType;
import uk.ac.glam.wcsclient.wcs111.InterpolationMethodsType;
import uk.ac.glam.wcsclient.wcs111.OutputType;
import uk.ac.glam.wcsclient.wcs111.RangeSubsetType;
import uk.ac.glam.wcsclient.wcs111.RangeType;
import uk.ac.glam.wcsclient.wcs111.RequestBaseType;
...
import uk.ac.glam.wcsclient.wcs111.Wcs111Factory;
import uk.ac.glam.wcsclient.wcs111.Wcs111Package;

import uk.ac.glam.wcsclient.wcs111.util.Wcs111Validator;
...
public class Wcs111PackageImpl extends EPackageImpl implements Wcs111Package {
	 ...
	 * @see uk.ac.glam.wcsclient.wcs111.Wcs111Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * 
	 * <p>This method is used to initialize {@link Wcs111Package#eINSTANCE} when that field is accessed.
	...
	public static Wcs111Package init() {
		...
		Wcs111PackageImpl theWcs111Package = (Wcs111PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Wcs111PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Wcs111PackageImpl());
		...
		EPackage.Registry.INSTANCE.put(Wcs111Package.eNS_URI, theWcs111Package);
	 ...
	 * @generated
	 */
	public EReference getGridCrsType_SrsName() {
		return (EReference)gridCrsTypeEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getImageCRSRefType_ImageCRS() {
		return (EReference)imageCRSRefTypeEClass.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getImageCRSRefType_Actuate() {
		return (EAttribute)imageCRSRefTypeEClass.getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getImageCRSRefType_Arcrole() {
		return (EAttribute)imageCRSRefTypeEClass.getEStructuralFeatures().get(2);
	}
	...
	public EAttribute getImageCRSRefType_Href() {
		return (EAttribute)imageCRSRefTypeEClass.getEStructuralFeatures().get(3);
	}
	...
	public EAttribute getImageCRSRefType_RemoteSchema() {
		return (EAttribute)imageCRSRefTypeEClass.getEStructuralFeatures().get(4);
	}
	...
	public EAttribute getImageCRSRefType_Role() {
		return (EAttribute)imageCRSRefTypeEClass.getEStructuralFeatures().get(5);
	}
	...
	public EAttribute getImageCRSRefType_Show() {
		return (EAttribute)imageCRSRefTypeEClass.getEStructuralFeatures().get(6);
	}
	...
	public EAttribute getImageCRSRefType_Title() {
		return (EAttribute)imageCRSRefTypeEClass.getEStructuralFeatures().get(7);
	}
	...
	public EAttribute getImageCRSRefType_Type() {
		return (EAttribute)imageCRSRefTypeEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 * @generated
	 */
	public EReference getSpatialDomainType_Transformation() {
	...
	public EReference getSpatialDomainType_Polygon() {
		return (EReference)spatialDomainTypeEClass.getEStructuralFeatures().get(5);
	}
	...
	public void createPackageContents() {
		...
		createEReference(gridCrsTypeEClass, GRID_CRS_TYPE__SRS_NAME);
		...
		createEReference(imageCRSRefTypeEClass, IMAGE_CRS_REF_TYPE__IMAGE_CRS);
		createEAttribute(imageCRSRefTypeEClass, IMAGE_CRS_REF_TYPE__ACTUATE);
		createEAttribute(imageCRSRefTypeEClass, IMAGE_CRS_REF_TYPE__ARCROLE);
		createEAttribute(imageCRSRefTypeEClass, IMAGE_CRS_REF_TYPE__HREF);
		createEAttribute(imageCRSRefTypeEClass, IMAGE_CRS_REF_TYPE__REMOTE_SCHEMA);
		createEAttribute(imageCRSRefTypeEClass, IMAGE_CRS_REF_TYPE__ROLE);
		createEAttribute(imageCRSRefTypeEClass, IMAGE_CRS_REF_TYPE__SHOW);
		createEAttribute(imageCRSRefTypeEClass, IMAGE_CRS_REF_TYPE__TITLE);
		createEAttribute(imageCRSRefTypeEClass, IMAGE_CRS_REF_TYPE__TYPE);
		...
		createEReference(spatialDomainTypeEClass, SPATIAL_DOMAIN_TYPE__TRANSFORMATION);
	...
	public void initializePackageContents() {
		...
		Ows110Package theOws110Package = (Ows110Package)EPackage.Registry.INSTANCE.getEPackage(Ows110Package.eNS_URI);
		...
		axisTypeEClass.getESuperTypes().add(theOws110Package.getDescriptionType());
		capabilitiesTypeEClass.getESuperTypes().add(theOws110Package.getCapabilitiesBaseType());
		coverageDescriptionTypeEClass.getESuperTypes().add(theOws110Package.getDescriptionType());
		coverageSummaryTypeEClass.getESuperTypes().add(theOws110Package.getDescriptionType());
		describeCoverageTypeEClass.getESuperTypes().add(this.getRequestBaseType());
		fieldTypeEClass.getESuperTypes().add(theOws110Package.getDescriptionType());
		getCapabilitiesTypeEClass.getESuperTypes().add(theOws110Package.getGetCapabilitiesType());
		getCoverageTypeEClass.getESuperTypes().add(this.getRequestBaseType());
		interpolationMethodBaseTypeEClass.getESuperTypes().add(theOws110Package.getCodeType());
		...
		initEReference(getAxisType_Meaning(), theOws110Package.getDomainMetadataType(), null, "meaning", null, 0, 1, AxisType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAxisType_DataType(), theOws110Package.getDomainMetadataType(), null, "dataType", null, 0, 1, AxisType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAxisType_UOM(), theOws110Package.getDomainMetadataType(), null, "uOM", null, 0, 1, AxisType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAxisType_ReferenceSystem(), theOws110Package.getDomainMetadataType(), null, "referenceSystem", null, 0, 1, AxisType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAxisType_Metadata(), theOws110Package.getMetadataType(), null, "metadata", null, 0, -1, AxisType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getContentsType_SupportedFormat(), theOws110Package.getMimeType(), "supportedFormat", null, 0, -1, ContentsType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContentsType_OtherSource(), theOws110Package.getOnlineResourceType(), null, "otherSource", null, 0, -1, ContentsType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCoverageDescriptionType_Metadata(), theOws110Package.getMetadataType(), null, "metadata", null, 0, -1, CoverageDescriptionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCoverageDescriptionType_SupportedFormat(), theOws110Package.getMimeType(), "supportedFormat", null, 1, -1, CoverageDescriptionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCoveragesType_Coverage(), theOws110Package.getReferenceGroupType(), null, "coverage", null, 1, -1, CoveragesType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCoverageSummaryType_Metadata(), theOws110Package.getMetadataType(), null, "metadata", null, 0, -1, CoverageSummaryType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCoverageSummaryType_WGS84BoundingBox(), theOws110Package.getWGS84BoundingBoxType(), null, "wGS84BoundingBox", null, 0, -1, CoverageSummaryType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCoverageSummaryType_SupportedFormat(), theOws110Package.getMimeType(), "supportedFormat", null, 0, -1, CoverageSummaryType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDocumentRoot_Coverage(), theOws110Package.getReferenceGroupType(), null, "coverage", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDocumentRoot_GridOffsets(), theGml311Package.getDoubleList(), "gridOffsets", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getDocumentRoot_GridOrigin(), theGml311Package.getDoubleList(), "gridOrigin", "0 0", 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDomainSubsetType_BoundingBox(), theOws110Package.getBoundingBoxType(), null, "boundingBox", null, 1, 1, DomainSubsetType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFieldSubsetType_Identifier(), theOws110Package.getCodeType(), null, "identifier", null, 1, 1, FieldSubsetType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFieldType_Definition(), theOws110Package.getUnNamedDomainType(), null, "definition", null, 1, 1, FieldType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFieldType_NullValue(), theOws110Package.getCodeType(), null, "nullValue", null, 0, -1, FieldType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getGetCapabilitiesType_Service(), theOws110Package.getServiceType(), "service", "WCS", 1, 1, GetCapabilitiesType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGetCoverageType_Identifier(), theOws110Package.getCodeType(), null, "identifier", null, 1, 1, GetCoverageType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGridCrsType_SrsName(), theGml311Package.getCodeType(), null, "srsName", null, 0, 1, GridCrsType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getGridCrsType_GridOrigin(), theGml311Package.getDoubleList(), "gridOrigin", "0 0", 0, 1, GridCrsType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGridCrsType_GridOffsets(), theGml311Package.getDoubleList(), "gridOffsets", null, 1, 1, GridCrsType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getGridCrsType_Id(), theXMLTypePackage.getID(), "id", null, 0, 1, GridCrsType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getImageCRSRefType_ImageCRS(), theGml311Package.getImageCRSType(), null, "imageCRS", null, 0, 1, ImageCRSRefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getImageCRSRefType_Actuate(), theXlinkPackage.getActuateType(), "actuate", null, 0, 1, ImageCRSRefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getImageCRSRefType_Arcrole(), theXMLTypePackage.getAnyURI(), "arcrole", null, 0, 1, ImageCRSRefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getImageCRSRefType_Href(), theXMLTypePackage.getAnyURI(), "href", null, 0, 1, ImageCRSRefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getImageCRSRefType_RemoteSchema(), theXMLTypePackage.getAnyURI(), "remoteSchema", null, 0, 1, ImageCRSRefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getImageCRSRefType_Role(), theXMLTypePackage.getAnyURI(), "role", null, 0, 1, ImageCRSRefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getImageCRSRefType_Show(), theXlinkPackage.getShowType(), "show", null, 0, 1, ImageCRSRefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getImageCRSRefType_Title(), theXMLTypePackage.getString(), "title", null, 0, 1, ImageCRSRefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getImageCRSRefType_Type(), theXMLTypePackage.getString(), "type", "simple", 0, 1, ImageCRSRefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getOutputType_Format(), theOws110Package.getMimeType(), "format", null, 0, 1, OutputType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSpatialDomainType_BoundingBox(), theOws110Package.getBoundingBoxType(), null, "boundingBox", null, 1, -1, SpatialDomainType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSpatialDomainType_Transformation(), theGml311Package.getAbstractCoordinateOperationType(), null, "transformation", null, 0, 1, SpatialDomainType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSpatialDomainType_Polygon(), theGml311Package.getPolygonType(), null, "polygon", null, 0, -1, SpatialDomainType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(timePeriodTypeEClass, TimePeriodType.class, "TimePeriodType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTimePeriodType_BeginPosition(), theGml311Package.getTimePositionType(), null, "beginPosition", null, 1, 1, TimePeriodType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTimePeriodType_EndPosition(), theGml311Package.getTimePositionType(), null, "endPosition", null, 1, 1, TimePeriodType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTimeSequenceType_TimePosition(), theGml311Package.getTimePositionType(), null, "timePosition", null, 0, -1, TimeSequenceType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (getImageCRSRefType_RemoteSchema(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "remoteSchema",
