 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.CapabilitiesBaseType#getServiceIdentification <em>Service Identification</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.CapabilitiesBaseType#getServiceProvider <em>Service Provider</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.CapabilitiesBaseType#getOperationsMetadata <em>Operations Metadata</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.CapabilitiesBaseType#getUpdateSequence <em>Update Sequence</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.CapabilitiesBaseType#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getCapabilitiesBaseType()
...
public interface CapabilitiesBaseType extends EObject {
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getCapabilitiesBaseType_ServiceIdentification()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.CapabilitiesBaseType#getServiceIdentification <em>Service Identification</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getCapabilitiesBaseType_ServiceProvider()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.CapabilitiesBaseType#getServiceProvider <em>Service Provider</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getCapabilitiesBaseType_OperationsMetadata()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.CapabilitiesBaseType#getOperationsMetadata <em>Operations Metadata</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getCapabilitiesBaseType_UpdateSequence()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.CapabilitiesBaseType#getUpdateSequence <em>Update Sequence</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getCapabilitiesBaseType_Version()
	 * @model dataType="uk.ac.glam.wcsclient.ows110.VersionType1" required="true"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.CapabilitiesBaseType#getVersion <em>Version</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
