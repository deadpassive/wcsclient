 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.ServiceIdentificationType#getServiceType <em>Service Type</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.ServiceIdentificationType#getServiceTypeVersion <em>Service Type Version</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.ServiceIdentificationType#getProfile <em>Profile</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.ServiceIdentificationType#getFees <em>Fees</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.ServiceIdentificationType#getAccessConstraints <em>Access Constraints</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getServiceIdentificationType()
...
public interface ServiceIdentificationType extends DescriptionType {
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getServiceIdentificationType_ServiceType()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.ServiceIdentificationType#getServiceType <em>Service Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getServiceIdentificationType_ServiceTypeVersion()
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getServiceIdentificationType_Profile()
	 ...
	 * @see #setFees(String)
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getServiceIdentificationType_Fees()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.ServiceIdentificationType#getFees <em>Fees</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getServiceIdentificationType_AccessConstraints()
