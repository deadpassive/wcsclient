 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ResponsiblePartyTypeImpl#getIndividualName <em>Individual Name</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ResponsiblePartyTypeImpl#getOrganisationName <em>Organisation Name</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ResponsiblePartyTypeImpl#getPositionName <em>Position Name</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ResponsiblePartyTypeImpl#getContactInfo <em>Contact Info</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ResponsiblePartyTypeImpl#getRole <em>Role</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResponsiblePartyTypeImpl extends EObjectImpl implements ResponsiblePartyType {
	...
	protected EClass eStaticClass() {
		return Ows110Package.Literals.RESPONSIBLE_PARTY_TYPE;
	}
	...
	public void setIndividualName(String newIndividualName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.RESPONSIBLE_PARTY_TYPE__INDIVIDUAL_NAME, oldIndividualName, individualName));
	}
	...
	public void setOrganisationName(String newOrganisationName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.RESPONSIBLE_PARTY_TYPE__ORGANISATION_NAME, oldOrganisationName, organisationName));
	}
	...
	public void setPositionName(String newPositionName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.RESPONSIBLE_PARTY_TYPE__POSITION_NAME, oldPositionName, positionName));
	}
	...
	public NotificationChain basicSetContactInfo(ContactType newContactInfo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Ows110Package.RESPONSIBLE_PARTY_TYPE__CONTACT_INFO, oldContactInfo, newContactInfo);
	...
	public void setContactInfo(ContactType newContactInfo) {
		if (newContactInfo != contactInfo) {
			...
			if (contactInfo != null)
				msgs = ((InternalEObject)contactInfo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Ows110Package.RESPONSIBLE_PARTY_TYPE__CONTACT_INFO, null, msgs);
			if (newContactInfo != null)
				msgs = ((InternalEObject)newContactInfo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Ows110Package.RESPONSIBLE_PARTY_TYPE__CONTACT_INFO, null, msgs);
			msgs = basicSetContactInfo(newContactInfo, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.RESPONSIBLE_PARTY_TYPE__CONTACT_INFO, newContactInfo, newContactInfo));
	}
	...
	public NotificationChain basicSetRole(CodeType newRole, NotificationChain msgs) {
		...
		role = newRole;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Ows110Package.RESPONSIBLE_PARTY_TYPE__ROLE, oldRole, newRole);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRole(CodeType newRole) {
		if (newRole != role) {
			NotificationChain msgs = null;
			if (role != null)
				msgs = ((InternalEObject)role).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Ows110Package.RESPONSIBLE_PARTY_TYPE__ROLE, null, msgs);
			if (newRole != null)
				msgs = ((InternalEObject)newRole).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Ows110Package.RESPONSIBLE_PARTY_TYPE__ROLE, null, msgs);
			msgs = basicSetRole(newRole, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.RESPONSIBLE_PARTY_TYPE__ROLE, newRole, newRole));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Ows110Package.RESPONSIBLE_PARTY_TYPE__CONTACT_INFO:
				return basicSetContactInfo(null, msgs);
			case Ows110Package.RESPONSIBLE_PARTY_TYPE__ROLE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ows110Package.RESPONSIBLE_PARTY_TYPE__INDIVIDUAL_NAME:
				return getIndividualName();
			case Ows110Package.RESPONSIBLE_PARTY_TYPE__ORGANISATION_NAME:
				return getOrganisationName();
			case Ows110Package.RESPONSIBLE_PARTY_TYPE__POSITION_NAME:
