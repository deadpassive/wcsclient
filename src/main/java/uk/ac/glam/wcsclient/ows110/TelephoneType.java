 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.TelephoneType#getVoice <em>Voice</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.TelephoneType#getFacsimile <em>Facsimile</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getTelephoneType()
...
public interface TelephoneType extends EObject {
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getTelephoneType_Voice()
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getTelephoneType_Facsimile()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.String"
