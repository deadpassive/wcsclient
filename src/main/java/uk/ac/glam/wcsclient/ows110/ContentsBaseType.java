 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.ContentsBaseType#getDatasetDescriptionSummary <em>Dataset Description Summary</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.ContentsBaseType#getOtherSource <em>Other Source</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getContentsBaseType()
...
public interface ContentsBaseType extends EObject {
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getContentsBaseType_DatasetDescriptionSummary()
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getContentsBaseType_OtherSource()
	 * @model containment="true"
