 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.AcceptVersionsTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AcceptVersionsTypeImpl extends EObjectImpl implements AcceptVersionsType {
	...
	protected EClass eStaticClass() {
		return Ows110Package.Literals.ACCEPT_VERSIONS_TYPE;
	}
	...
	public EList<String> getVersion() {
		if (version == null) {
			version = new EDataTypeEList<String>(String.class, this, Ows110Package.ACCEPT_VERSIONS_TYPE__VERSION);
		}
		return version;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ows110Package.ACCEPT_VERSIONS_TYPE__VERSION:
				return getVersion();
		}
