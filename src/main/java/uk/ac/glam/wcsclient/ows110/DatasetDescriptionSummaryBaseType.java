 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.DatasetDescriptionSummaryBaseType#getWGS84BoundingBox <em>WGS84 Bounding Box</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.DatasetDescriptionSummaryBaseType#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.DatasetDescriptionSummaryBaseType#getBoundingBoxGroup <em>Bounding Box Group</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.DatasetDescriptionSummaryBaseType#getBoundingBox <em>Bounding Box</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.DatasetDescriptionSummaryBaseType#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.DatasetDescriptionSummaryBaseType#getDatasetDescriptionSummary <em>Dataset Description Summary</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getDatasetDescriptionSummaryBaseType()
...
public interface DatasetDescriptionSummaryBaseType extends DescriptionType {
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getDatasetDescriptionSummaryBaseType_WGS84BoundingBox()
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getDatasetDescriptionSummaryBaseType_Identifier()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.DatasetDescriptionSummaryBaseType#getIdentifier <em>Identifier</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getDatasetDescriptionSummaryBaseType_BoundingBoxGroup()
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getDatasetDescriptionSummaryBaseType_BoundingBox()
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getDatasetDescriptionSummaryBaseType_Metadata()
	 * @model containment="true"
	 ...
	 * The list contents are of type {@link uk.ac.glam.wcsclient.ows110.DatasetDescriptionSummaryBaseType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getDatasetDescriptionSummaryBaseType_DatasetDescriptionSummary()
	 * @model containment="true"
