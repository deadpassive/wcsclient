 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.ContactType#getPhone <em>Phone</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.ContactType#getAddress <em>Address</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.ContactType#getOnlineResource <em>Online Resource</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.ContactType#getHoursOfService <em>Hours Of Service</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.ContactType#getContactInstructions <em>Contact Instructions</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getContactType()
...
public interface ContactType extends EObject {
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getContactType_Phone()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.ContactType#getPhone <em>Phone</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getContactType_Address()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.ContactType#getAddress <em>Address</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getContactType_OnlineResource()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.ContactType#getOnlineResource <em>Online Resource</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getContactType_HoursOfService()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.ContactType#getHoursOfService <em>Hours Of Service</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getContactType_ContactInstructions()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.ContactType#getContactInstructions <em>Contact Instructions</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
