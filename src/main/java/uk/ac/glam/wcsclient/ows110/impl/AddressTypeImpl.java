 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.AddressTypeImpl#getDeliveryPoint <em>Delivery Point</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.AddressTypeImpl#getCity <em>City</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.AddressTypeImpl#getAdministrativeArea <em>Administrative Area</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.AddressTypeImpl#getPostalCode <em>Postal Code</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.AddressTypeImpl#getCountry <em>Country</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.AddressTypeImpl#getElectronicMailAddress <em>Electronic Mail Address</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddressTypeImpl extends EObjectImpl implements AddressType {
	...
	protected EClass eStaticClass() {
		return Ows110Package.Literals.ADDRESS_TYPE;
	}
	...
	public EList<String> getDeliveryPoint() {
		if (deliveryPoint == null) {
			deliveryPoint = new EDataTypeEList<String>(String.class, this, Ows110Package.ADDRESS_TYPE__DELIVERY_POINT);
		}
	...
	public void setCity(String newCity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.ADDRESS_TYPE__CITY, oldCity, city));
	}
	...
	public void setAdministrativeArea(String newAdministrativeArea) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.ADDRESS_TYPE__ADMINISTRATIVE_AREA, oldAdministrativeArea, administrativeArea));
	}
	...
	public void setPostalCode(String newPostalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.ADDRESS_TYPE__POSTAL_CODE, oldPostalCode, postalCode));
	}
	...
	public void setCountry(String newCountry) {
		...
		country = newCountry;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.ADDRESS_TYPE__COUNTRY, oldCountry, country));
	}
	...
	public EList<String> getElectronicMailAddress() {
		if (electronicMailAddress == null) {
			electronicMailAddress = new EDataTypeEList<String>(String.class, this, Ows110Package.ADDRESS_TYPE__ELECTRONIC_MAIL_ADDRESS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ows110Package.ADDRESS_TYPE__DELIVERY_POINT:
				return getDeliveryPoint();
			case Ows110Package.ADDRESS_TYPE__CITY:
				return getCity();
			case Ows110Package.ADDRESS_TYPE__ADMINISTRATIVE_AREA:
				return getAdministrativeArea();
			case Ows110Package.ADDRESS_TYPE__POSTAL_CODE:
				return getPostalCode();
			case Ows110Package.ADDRESS_TYPE__COUNTRY:
				return getCountry();
			case Ows110Package.ADDRESS_TYPE__ELECTRONIC_MAIL_ADDRESS:
