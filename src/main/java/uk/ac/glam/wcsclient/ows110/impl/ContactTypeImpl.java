 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ContactTypeImpl#getPhone <em>Phone</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ContactTypeImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ContactTypeImpl#getOnlineResource <em>Online Resource</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ContactTypeImpl#getHoursOfService <em>Hours Of Service</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ContactTypeImpl#getContactInstructions <em>Contact Instructions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContactTypeImpl extends EObjectImpl implements ContactType {
	...
	protected EClass eStaticClass() {
		return Ows110Package.Literals.CONTACT_TYPE;
	}
	...
	public NotificationChain basicSetPhone(TelephoneType newPhone, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Ows110Package.CONTACT_TYPE__PHONE, oldPhone, newPhone);
	...
	public void setPhone(TelephoneType newPhone) {
		if (newPhone != phone) {
			...
			if (phone != null)
				msgs = ((InternalEObject)phone).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Ows110Package.CONTACT_TYPE__PHONE, null, msgs);
			if (newPhone != null)
				msgs = ((InternalEObject)newPhone).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Ows110Package.CONTACT_TYPE__PHONE, null, msgs);
			msgs = basicSetPhone(newPhone, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.CONTACT_TYPE__PHONE, newPhone, newPhone));
	}
	...
	public NotificationChain basicSetAddress(AddressType newAddress, NotificationChain msgs) {
		...
		address = newAddress;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Ows110Package.CONTACT_TYPE__ADDRESS, oldAddress, newAddress);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAddress(AddressType newAddress) {
		if (newAddress != address) {
			NotificationChain msgs = null;
			if (address != null)
				msgs = ((InternalEObject)address).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Ows110Package.CONTACT_TYPE__ADDRESS, null, msgs);
			if (newAddress != null)
				msgs = ((InternalEObject)newAddress).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Ows110Package.CONTACT_TYPE__ADDRESS, null, msgs);
			msgs = basicSetAddress(newAddress, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.CONTACT_TYPE__ADDRESS, newAddress, newAddress));
	}
	...
	public NotificationChain basicSetOnlineResource(OnlineResourceType newOnlineResource, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Ows110Package.CONTACT_TYPE__ONLINE_RESOURCE, oldOnlineResource, newOnlineResource);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOnlineResource(OnlineResourceType newOnlineResource) {
		if (newOnlineResource != onlineResource) {
			...
			if (onlineResource != null)
				msgs = ((InternalEObject)onlineResource).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Ows110Package.CONTACT_TYPE__ONLINE_RESOURCE, null, msgs);
			if (newOnlineResource != null)
				msgs = ((InternalEObject)newOnlineResource).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Ows110Package.CONTACT_TYPE__ONLINE_RESOURCE, null, msgs);
			msgs = basicSetOnlineResource(newOnlineResource, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.CONTACT_TYPE__ONLINE_RESOURCE, newOnlineResource, newOnlineResource));
	}
	...
	public void setHoursOfService(String newHoursOfService) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.CONTACT_TYPE__HOURS_OF_SERVICE, oldHoursOfService, hoursOfService));
	}
	...
	public void setContactInstructions(String newContactInstructions) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.CONTACT_TYPE__CONTACT_INSTRUCTIONS, oldContactInstructions, contactInstructions));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Ows110Package.CONTACT_TYPE__PHONE:
				return basicSetPhone(null, msgs);
			case Ows110Package.CONTACT_TYPE__ADDRESS:
				return basicSetAddress(null, msgs);
			case Ows110Package.CONTACT_TYPE__ONLINE_RESOURCE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Ows110Package.CONTACT_TYPE__HOURS_OF_SERVICE:
				return getHoursOfService();
			case Ows110Package.CONTACT_TYPE__CONTACT_INSTRUCTIONS:
