 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ServiceIdentificationTypeImpl#getServiceType <em>Service Type</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ServiceIdentificationTypeImpl#getServiceTypeVersion <em>Service Type Version</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ServiceIdentificationTypeImpl#getProfile <em>Profile</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ServiceIdentificationTypeImpl#getFees <em>Fees</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ServiceIdentificationTypeImpl#getAccessConstraints <em>Access Constraints</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServiceIdentificationTypeImpl extends DescriptionTypeImpl implements ServiceIdentificationType {
	...
	protected EClass eStaticClass() {
		return Ows110Package.Literals.SERVICE_IDENTIFICATION_TYPE;
	}
	...
	public NotificationChain basicSetServiceType(CodeType newServiceType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Ows110Package.SERVICE_IDENTIFICATION_TYPE__SERVICE_TYPE, oldServiceType, newServiceType);
	...
	public void setServiceType(CodeType newServiceType) {
		if (newServiceType != serviceType) {
			...
			if (serviceType != null)
				msgs = ((InternalEObject)serviceType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Ows110Package.SERVICE_IDENTIFICATION_TYPE__SERVICE_TYPE, null, msgs);
			if (newServiceType != null)
				msgs = ((InternalEObject)newServiceType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Ows110Package.SERVICE_IDENTIFICATION_TYPE__SERVICE_TYPE, null, msgs);
			msgs = basicSetServiceType(newServiceType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.SERVICE_IDENTIFICATION_TYPE__SERVICE_TYPE, newServiceType, newServiceType));
	}
	...
	public EList<String> getServiceTypeVersion() {
		if (serviceTypeVersion == null) {
			serviceTypeVersion = new EDataTypeEList<String>(String.class, this, Ows110Package.SERVICE_IDENTIFICATION_TYPE__SERVICE_TYPE_VERSION);
		}
	...
	public EList<String> getProfile() {
		if (profile == null) {
			profile = new EDataTypeEList<String>(String.class, this, Ows110Package.SERVICE_IDENTIFICATION_TYPE__PROFILE);
		}
		return profile;
	}
	...
	public void setFees(String newFees) {
		...
		fees = newFees;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.SERVICE_IDENTIFICATION_TYPE__FEES, oldFees, fees));
	}
	...
	public EList<String> getAccessConstraints() {
		if (accessConstraints == null) {
			accessConstraints = new EDataTypeEList<String>(String.class, this, Ows110Package.SERVICE_IDENTIFICATION_TYPE__ACCESS_CONSTRAINTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Ows110Package.SERVICE_IDENTIFICATION_TYPE__SERVICE_TYPE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Ows110Package.SERVICE_IDENTIFICATION_TYPE__SERVICE_TYPE_VERSION:
				return getServiceTypeVersion();
			case Ows110Package.SERVICE_IDENTIFICATION_TYPE__PROFILE:
				return getProfile();
			case Ows110Package.SERVICE_IDENTIFICATION_TYPE__FEES:
				return getFees();
			case Ows110Package.SERVICE_IDENTIFICATION_TYPE__ACCESS_CONSTRAINTS:
