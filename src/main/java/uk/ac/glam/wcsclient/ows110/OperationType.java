 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.OperationType#getDCP <em>DCP</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.OperationType#getParameter <em>Parameter</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.OperationType#getConstraint <em>Constraint</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.OperationType#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.OperationType#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getOperationType()
...
public interface OperationType extends EObject {
	 ...
	 * The list contents are of type {@link uk.ac.glam.wcsclient.ows110.DCPType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getOperationType_DCP()
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getOperationType_Parameter()
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getOperationType_Constraint()
	 * @model containment="true"
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getOperationType_Metadata()
	 * @model containment="true"
	 ...
	 * @see #setName(String)
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getOperationType_Name()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.OperationType#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
