 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ExceptionTypeImpl#getExceptionText <em>Exception Text</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ExceptionTypeImpl#getExceptionCode <em>Exception Code</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ExceptionTypeImpl#getLocator <em>Locator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExceptionTypeImpl extends EObjectImpl implements ExceptionType {
	...
	protected EClass eStaticClass() {
		return Ows110Package.Literals.EXCEPTION_TYPE;
	}
	...
	public EList<String> getExceptionText() {
		if (exceptionText == null) {
			exceptionText = new EDataTypeEList<String>(String.class, this, Ows110Package.EXCEPTION_TYPE__EXCEPTION_TEXT);
		}
	...
	public void setExceptionCode(String newExceptionCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.EXCEPTION_TYPE__EXCEPTION_CODE, oldExceptionCode, exceptionCode));
	}
	...
	public void setLocator(String newLocator) {
		...
		locator = newLocator;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.EXCEPTION_TYPE__LOCATOR, oldLocator, locator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ows110Package.EXCEPTION_TYPE__EXCEPTION_TEXT:
				return getExceptionText();
			case Ows110Package.EXCEPTION_TYPE__EXCEPTION_CODE:
				return getExceptionCode();
			case Ows110Package.EXCEPTION_TYPE__LOCATOR:
				return getLocator();
		}
