 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.DescriptionType#getTitle <em>Title</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.DescriptionType#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.DescriptionType#getKeywords <em>Keywords</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getDescriptionType()
...
public interface DescriptionType extends EObject {
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getDescriptionType_Title()
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getDescriptionType_Abstract()
	 * @model containment="true"
	 ...
	 * The list contents are of type {@link uk.ac.glam.wcsclient.ows110.KeywordsType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getDescriptionType_Keywords()
	 * @model containment="true"
