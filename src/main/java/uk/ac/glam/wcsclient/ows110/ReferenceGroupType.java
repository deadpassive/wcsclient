 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.ReferenceGroupType#getAbstractReferenceBaseGroup <em>Abstract Reference Base Group</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.ReferenceGroupType#getAbstractReferenceBase <em>Abstract Reference Base</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getReferenceGroupType()
...
public interface ReferenceGroupType extends BasicIdentificationType {
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getReferenceGroupType_AbstractReferenceBaseGroup()
	 ...
	 * The list contents are of type {@link uk.ac.glam.wcsclient.ows110.AbstractReferenceBaseType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getReferenceGroupType_AbstractReferenceBase()
