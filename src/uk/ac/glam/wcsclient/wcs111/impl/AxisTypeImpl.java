 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.AxisTypeImpl#getAvailableKeys <em>Available Keys</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.AxisTypeImpl#getMeaning <em>Meaning</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.AxisTypeImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.AxisTypeImpl#getUOM <em>UOM</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.AxisTypeImpl#getReferenceSystem <em>Reference System</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.AxisTypeImpl#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.AxisTypeImpl#getIdentifier <em>Identifier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AxisTypeImpl extends DescriptionTypeImpl implements AxisType {
	...
	public EList<MetadataType> getMetadata() {
		if (metadata == null) {
			metadata = new EObjectContainmentEList<MetadataType>(MetadataType.class, this, Wcs111Package.AXIS_TYPE__METADATA);
		}
		return metadata;
	}
