 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getAvailableKeys <em>Available Keys</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getAxisSubset <em>Axis Subset</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getCapabilities <em>Capabilities</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getContents <em>Contents</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getCoverage <em>Coverage</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getCoverageDescriptions <em>Coverage Descriptions</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getCoverages <em>Coverages</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getCoverageSummary <em>Coverage Summary</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getDescribeCoverage <em>Describe Coverage</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getGetCapabilities <em>Get Capabilities</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getGetCoverage <em>Get Coverage</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getGridBaseCRS <em>Grid Base CRS</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getGridCRS <em>Grid CRS</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getGridCS <em>Grid CS</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getGridOffsets <em>Grid Offsets</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getGridOrigin <em>Grid Origin</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getGridType <em>Grid Type</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getInterpolationMethods <em>Interpolation Methods</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getTemporalDomain <em>Temporal Domain</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.DocumentRootImpl#getTemporalSubset <em>Temporal Subset</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot {
	...
	public EMap<String, String> getXMLNSPrefixMap() {
		if (xMLNSPrefixMap == null) {
			xMLNSPrefixMap = new EcoreEMap<String,String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class, this, Wcs111Package.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
		}
	...
	public EMap<String, String> getXSISchemaLocation() {
		if (xSISchemaLocation == null) {
			xSISchemaLocation = new EcoreEMap<String,String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class, this, Wcs111Package.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
		}
	...
	public List<Double> getGridOffsets() {
		return (List<Double>)getMixed().get(Wcs111Package.Literals.DOCUMENT_ROOT__GRID_OFFSETS, true);
	}
	...
	public List<Double> getGridOrigin() {
		return (List<Double>)getMixed().get(Wcs111Package.Literals.DOCUMENT_ROOT__GRID_ORIGIN, true);
	}
