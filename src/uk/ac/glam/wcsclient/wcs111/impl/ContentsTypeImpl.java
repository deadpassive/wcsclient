 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.ContentsTypeImpl#getCoverageSummary <em>Coverage Summary</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.ContentsTypeImpl#getSupportedCRS <em>Supported CRS</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.ContentsTypeImpl#getSupportedFormat <em>Supported Format</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.ContentsTypeImpl#getOtherSource <em>Other Source</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContentsTypeImpl extends EObjectImpl implements ContentsType {
	 ...
	 * @ordered
	 */
	protected EList<OnlineResourceType> otherSource;
	...
	public EList<CoverageSummaryType> getCoverageSummary() {
		if (coverageSummary == null) {
			coverageSummary = new EObjectContainmentEList<CoverageSummaryType>(CoverageSummaryType.class, this, Wcs111Package.CONTENTS_TYPE__COVERAGE_SUMMARY);
		}
	...
	public EList<String> getSupportedCRS() {
		if (supportedCRS == null) {
			supportedCRS = new EDataTypeEList<String>(String.class, this, Wcs111Package.CONTENTS_TYPE__SUPPORTED_CRS);
		}
		return supportedCRS;
	}
	...
	public EList<String> getSupportedFormat() {
		if (supportedFormat == null) {
			supportedFormat = new EDataTypeEList<String>(String.class, this, Wcs111Package.CONTENTS_TYPE__SUPPORTED_FORMAT);
		}
	 ...
	 * @generated
	 */
	public EList<OnlineResourceType> getOtherSource() {
		if (otherSource == null) {
			otherSource = new EObjectContainmentEList<OnlineResourceType>(OnlineResourceType.class, this, Wcs111Package.CONTENTS_TYPE__OTHER_SOURCE);
		}
		return otherSource;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case Wcs111Package.CONTENTS_TYPE__OTHER_SOURCE:
				...
				getOtherSource().addAll((Collection<? extends OnlineResourceType>)newValue);
				return;
		}
