 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.FieldSubsetTypeImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.FieldSubsetTypeImpl#getInterpolationType <em>Interpolation Type</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.FieldSubsetTypeImpl#getAxisSubset <em>Axis Subset</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FieldSubsetTypeImpl extends EObjectImpl implements FieldSubsetType {
	...
	public EList<AxisSubsetType> getAxisSubset() {
		if (axisSubset == null) {
			axisSubset = new EObjectContainmentEList<AxisSubsetType>(AxisSubsetType.class, this, Wcs111Package.FIELD_SUBSET_TYPE__AXIS_SUBSET);
		}
		return axisSubset;
	}
