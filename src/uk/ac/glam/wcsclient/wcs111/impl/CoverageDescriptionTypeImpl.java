 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.CoverageDescriptionTypeImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.CoverageDescriptionTypeImpl#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.CoverageDescriptionTypeImpl#getDomain <em>Domain</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.CoverageDescriptionTypeImpl#getRange <em>Range</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.CoverageDescriptionTypeImpl#getSupportedCRS <em>Supported CRS</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.impl.CoverageDescriptionTypeImpl#getSupportedFormat <em>Supported Format</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CoverageDescriptionTypeImpl extends DescriptionTypeImpl implements CoverageDescriptionType {
	...
	public EList<MetadataType> getMetadata() {
		if (metadata == null) {
			metadata = new EObjectContainmentEList<MetadataType>(MetadataType.class, this, Wcs111Package.COVERAGE_DESCRIPTION_TYPE__METADATA);
		}
		return metadata;
	}
	...
	public EList<String> getSupportedCRS() {
		if (supportedCRS == null) {
			supportedCRS = new EDataTypeEList<String>(String.class, this, Wcs111Package.COVERAGE_DESCRIPTION_TYPE__SUPPORTED_CRS);
		}
		return supportedCRS;
	}
	...
	public EList<String> getSupportedFormat() {
		if (supportedFormat == null) {
			supportedFormat = new EDataTypeEList<String>(String.class, this, Wcs111Package.COVERAGE_DESCRIPTION_TYPE__SUPPORTED_FORMAT);
		}
