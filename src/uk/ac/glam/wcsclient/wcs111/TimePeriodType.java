 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.TimePeriodType#getBeginPosition <em>Begin Position</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.TimePeriodType#getEndPosition <em>End Position</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.TimePeriodType#getTimeResolution <em>Time Resolution</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.TimePeriodType#getFrame <em>Frame</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.wcs111.Wcs111Package#getTimePeriodType()
...
public interface TimePeriodType extends EObject {
	 ...
	 * @see uk.ac.glam.wcsclient.wcs111.Wcs111Package#getTimePeriodType_BeginPosition()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs111.TimePeriodType#getBeginPosition <em>Begin Position</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.wcs111.Wcs111Package#getTimePeriodType_EndPosition()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs111.TimePeriodType#getEndPosition <em>End Position</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.wcs111.Wcs111Package#getTimePeriodType_TimeResolution()
	 * @model dataType="uk.ac.glam.wcsclient.wcs111.TimeDurationType"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs111.TimePeriodType#getTimeResolution <em>Time Resolution</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #unsetFrame()
	 * @see #setFrame(String)
	 * @see uk.ac.glam.wcsclient.wcs111.Wcs111Package#getTimePeriodType_Frame()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs111.TimePeriodType#getFrame <em>Frame</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link uk.ac.glam.wcsclient.wcs111.TimePeriodType#getFrame <em>Frame</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetFrame()
	 * @see #getFrame()
	...
	/**
	 * Returns whether the value of the '{@link uk.ac.glam.wcsclient.wcs111.TimePeriodType#getFrame <em>Frame</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
