 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.SpatialDomainType#getBoundingBoxGroup <em>Bounding Box Group</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.SpatialDomainType#getBoundingBox <em>Bounding Box</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.SpatialDomainType#getGridCRS <em>Grid CRS</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.SpatialDomainType#getTransformation <em>Transformation</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.SpatialDomainType#getImageCRS <em>Image CRS</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.SpatialDomainType#getPolygon <em>Polygon</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.wcs111.Wcs111Package#getSpatialDomainType()
...
public interface SpatialDomainType extends EObject {
	 ...
	 * @see uk.ac.glam.wcsclient.wcs111.Wcs111Package#getSpatialDomainType_BoundingBoxGroup()
	 ...
	 * @see uk.ac.glam.wcsclient.wcs111.Wcs111Package#getSpatialDomainType_BoundingBox()
	 ...
	 * @see uk.ac.glam.wcsclient.wcs111.Wcs111Package#getSpatialDomainType_GridCRS()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs111.SpatialDomainType#getGridCRS <em>Grid CRS</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setTransformation(AbstractCoordinateOperationType)
	 * @see uk.ac.glam.wcsclient.wcs111.Wcs111Package#getSpatialDomainType_Transformation()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='Transformation' namespace='##targetNamespace'"
	 * @generated
	 */
	AbstractCoordinateOperationType getTransformation();

	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs111.SpatialDomainType#getTransformation <em>Transformation</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setTransformation(AbstractCoordinateOperationType value);
	 ...
	 * @see uk.ac.glam.wcsclient.wcs111.Wcs111Package#getSpatialDomainType_ImageCRS()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs111.SpatialDomainType#getImageCRS <em>Image CRS</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link uk.ac.glam.wcsclient.gml311.PolygonType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.wcs111.Wcs111Package#getSpatialDomainType_Polygon()
	 * @model containment="true"
