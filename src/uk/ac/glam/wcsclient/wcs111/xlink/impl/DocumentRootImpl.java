 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.xlink.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.xlink.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.xlink.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.xlink.impl.DocumentRootImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.xlink.impl.DocumentRootImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.xlink.impl.DocumentRootImpl#getFrom <em>From</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.xlink.impl.DocumentRootImpl#getHref <em>Href</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.xlink.impl.DocumentRootImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.xlink.impl.DocumentRootImpl#getRole <em>Role</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.xlink.impl.DocumentRootImpl#getShow <em>Show</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.xlink.impl.DocumentRootImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs111.xlink.impl.DocumentRootImpl#getTo <em>To</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
