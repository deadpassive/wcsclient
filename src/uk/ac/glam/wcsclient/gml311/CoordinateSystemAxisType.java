 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.CoordinateSystemAxisType#getAxisID <em>Axis ID</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.CoordinateSystemAxisType#getRemarks <em>Remarks</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.CoordinateSystemAxisType#getAxisAbbrev <em>Axis Abbrev</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.CoordinateSystemAxisType#getAxisDirection <em>Axis Direction</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.CoordinateSystemAxisType#getUom <em>Uom</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getCoordinateSystemAxisType()
...
public interface CoordinateSystemAxisType extends CoordinateSystemAxisBaseType {
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getCoordinateSystemAxisType_AxisID()
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getCoordinateSystemAxisType_Remarks()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.gml311.CoordinateSystemAxisType#getRemarks <em>Remarks</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getCoordinateSystemAxisType_AxisAbbrev()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.gml311.CoordinateSystemAxisType#getAxisAbbrev <em>Axis Abbrev</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getCoordinateSystemAxisType_AxisDirection()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.gml311.CoordinateSystemAxisType#getAxisDirection <em>Axis Direction</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setUom(String)
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getCoordinateSystemAxisType_Uom()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.gml311.CoordinateSystemAxisType#getUom <em>Uom</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
