 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.AbstractDatumType#getDatumID <em>Datum ID</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.AbstractDatumType#getRemarks <em>Remarks</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.AbstractDatumType#getAnchorPoint <em>Anchor Point</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.AbstractDatumType#getRealizationEpoch <em>Realization Epoch</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.AbstractDatumType#getValidArea <em>Valid Area</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.AbstractDatumType#getScope <em>Scope</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getAbstractDatumType()
 * @model abstract="true"
...
public interface AbstractDatumType extends AbstractDatumBaseType {
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getAbstractDatumType_DatumID()
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getAbstractDatumType_Remarks()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.gml311.AbstractDatumType#getRemarks <em>Remarks</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getAbstractDatumType_AnchorPoint()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.gml311.AbstractDatumType#getAnchorPoint <em>Anchor Point</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getAbstractDatumType_RealizationEpoch()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.gml311.AbstractDatumType#getRealizationEpoch <em>Realization Epoch</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getAbstractDatumType_ValidArea()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.gml311.AbstractDatumType#getValidArea <em>Valid Area</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setScope(String)
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getAbstractDatumType_Scope()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.gml311.AbstractDatumType#getScope <em>Scope</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
