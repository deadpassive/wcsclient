...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Null Enumeration Member0</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getNullEnumerationMember0()
 * @model extendedMetaData="name='NullEnumeration_._member_._0'"
 * @generated
 */
public enum NullEnumerationMember0 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Null Enumeration Member0</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final NullEnumerationMember0[] VALUES_ARRAY =
		new NullEnumerationMember0[] {
			INAPPLICABLE,
			MISSING,
			TEMPLATE,
			UNKNOWN,
	...
	/**
	 * A public read-only list of all the '<em><b>Null Enumeration Member0</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<NullEnumerationMember0> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Null Enumeration Member0</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static NullEnumerationMember0 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			NullEnumerationMember0 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Null Enumeration Member0</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Returns the '<em><b>Null Enumeration Member0</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	 ...
	 * @generated
	 */
	private NullEnumerationMember0(int value, String name, String literal) {
		this.value = value;
		this.name = name;
