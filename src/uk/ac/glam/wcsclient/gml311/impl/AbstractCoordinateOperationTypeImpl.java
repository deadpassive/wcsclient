 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.AbstractCoordinateOperationTypeImpl#getCoordinateOperationID <em>Coordinate Operation ID</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.AbstractCoordinateOperationTypeImpl#getRemarks <em>Remarks</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.AbstractCoordinateOperationTypeImpl#getOperationVersion <em>Operation Version</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.AbstractCoordinateOperationTypeImpl#getValidArea <em>Valid Area</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.AbstractCoordinateOperationTypeImpl#getScope <em>Scope</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.AbstractCoordinateOperationTypeImpl#getPositionalAccuracyGroup <em>Positional Accuracy Group</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.AbstractCoordinateOperationTypeImpl#getPositionalAccuracy <em>Positional Accuracy</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.AbstractCoordinateOperationTypeImpl#getSourceCRS <em>Source CRS</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.AbstractCoordinateOperationTypeImpl#getTargetCRS <em>Target CRS</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
