...
import uk.ac.glam.wcsclient.gml311.CurveInterpolationType;
 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.ArcStringByBulgeTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.ArcStringByBulgeTypeImpl#getPos <em>Pos</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.ArcStringByBulgeTypeImpl#getPointProperty <em>Point Property</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.ArcStringByBulgeTypeImpl#getPointRep <em>Point Rep</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.ArcStringByBulgeTypeImpl#getPosList <em>Pos List</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.ArcStringByBulgeTypeImpl#getCoordinates <em>Coordinates</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.ArcStringByBulgeTypeImpl#getBulge <em>Bulge</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.ArcStringByBulgeTypeImpl#getNormal <em>Normal</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.ArcStringByBulgeTypeImpl#getInterpolation <em>Interpolation</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.ArcStringByBulgeTypeImpl#getNumArc <em>Num Arc</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArcStringByBulgeTypeImpl extends AbstractCurveSegmentTypeImpl implements ArcStringByBulgeType {
	...
	protected EClass eStaticClass() {
		return Gml311Package.eINSTANCE.getArcStringByBulgeType();
	}
	...
	public NotificationChain basicSetPosList(DirectPositionListType newPosList, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Gml311Package.ARC_STRING_BY_BULGE_TYPE__POS_LIST, oldPosList, newPosList);
	...
	public void setPosList(DirectPositionListType newPosList) {
		if (newPosList != posList) {
			...
			if (posList != null)
				msgs = ((InternalEObject)posList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Gml311Package.ARC_STRING_BY_BULGE_TYPE__POS_LIST, null, msgs);
			if (newPosList != null)
				msgs = ((InternalEObject)newPosList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Gml311Package.ARC_STRING_BY_BULGE_TYPE__POS_LIST, null, msgs);
			msgs = basicSetPosList(newPosList, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.ARC_STRING_BY_BULGE_TYPE__POS_LIST, newPosList, newPosList));
	}
	...
	public NotificationChain basicSetCoordinates(CoordinatesType newCoordinates, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Gml311Package.ARC_STRING_BY_BULGE_TYPE__COORDINATES, oldCoordinates, newCoordinates);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCoordinates(CoordinatesType newCoordinates) {
		if (newCoordinates != coordinates) {
			NotificationChain msgs = null;
			if (coordinates != null)
				msgs = ((InternalEObject)coordinates).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Gml311Package.ARC_STRING_BY_BULGE_TYPE__COORDINATES, null, msgs);
			if (newCoordinates != null)
				msgs = ((InternalEObject)newCoordinates).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Gml311Package.ARC_STRING_BY_BULGE_TYPE__COORDINATES, null, msgs);
			msgs = basicSetCoordinates(newCoordinates, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.ARC_STRING_BY_BULGE_TYPE__COORDINATES, newCoordinates, newCoordinates));
	}
	...
	public void setInterpolation(CurveInterpolationType newInterpolation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.ARC_STRING_BY_BULGE_TYPE__INTERPOLATION, oldInterpolation, interpolation, !oldInterpolationESet));
	}
	...
	public void unsetInterpolation() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Gml311Package.ARC_STRING_BY_BULGE_TYPE__INTERPOLATION, oldInterpolation, INTERPOLATION_EDEFAULT, oldInterpolationESet));
	}
	...
	public void setNumArc(BigInteger newNumArc) {
		...
		numArc = newNumArc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.ARC_STRING_BY_BULGE_TYPE__NUM_ARC, oldNumArc, numArc));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Gml311Package.ARC_STRING_BY_BULGE_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case Gml311Package.ARC_STRING_BY_BULGE_TYPE__POS:
				return ((InternalEList<?>)getPos()).basicRemove(otherEnd, msgs);
			case Gml311Package.ARC_STRING_BY_BULGE_TYPE__POINT_PROPERTY:
				return ((InternalEList<?>)getPointProperty()).basicRemove(otherEnd, msgs);
			case Gml311Package.ARC_STRING_BY_BULGE_TYPE__POINT_REP:
			...
			case Gml311Package.ARC_STRING_BY_BULGE_TYPE__NORMAL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Gml311Package.ARC_STRING_BY_BULGE_TYPE__NORMAL:
				return getNormal();
			case Gml311Package.ARC_STRING_BY_BULGE_TYPE__INTERPOLATION:
				return getInterpolation();
			case Gml311Package.ARC_STRING_BY_BULGE_TYPE__NUM_ARC:
				return getNumArc();
		}
