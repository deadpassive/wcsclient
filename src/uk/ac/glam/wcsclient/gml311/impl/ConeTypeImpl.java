 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.ConeTypeImpl#getHorizontalCurveType <em>Horizontal Curve Type</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.ConeTypeImpl#getVerticalCurveType <em>Vertical Curve Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConeTypeImpl extends AbstractGriddedSurfaceTypeImpl implements ConeType {
	...
	protected EClass eStaticClass() {
		return Gml311Package.eINSTANCE.getConeType();
	}
	...
	public void setHorizontalCurveType(CurveInterpolationType newHorizontalCurveType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.CONE_TYPE__HORIZONTAL_CURVE_TYPE, oldHorizontalCurveType, horizontalCurveType, !oldHorizontalCurveTypeESet));
	}
	...
	public void unsetHorizontalCurveType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Gml311Package.CONE_TYPE__HORIZONTAL_CURVE_TYPE, oldHorizontalCurveType, HORIZONTAL_CURVE_TYPE_EDEFAULT, oldHorizontalCurveTypeESet));
	}
	...
	public void setVerticalCurveType(CurveInterpolationType newVerticalCurveType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.CONE_TYPE__VERTICAL_CURVE_TYPE, oldVerticalCurveType, verticalCurveType, !oldVerticalCurveTypeESet));
	}
	...
	public void unsetVerticalCurveType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Gml311Package.CONE_TYPE__VERTICAL_CURVE_TYPE, oldVerticalCurveType, VERTICAL_CURVE_TYPE_EDEFAULT, oldVerticalCurveTypeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Gml311Package.CONE_TYPE__HORIZONTAL_CURVE_TYPE:
				return getHorizontalCurveType();
			case Gml311Package.CONE_TYPE__VERTICAL_CURVE_TYPE:
