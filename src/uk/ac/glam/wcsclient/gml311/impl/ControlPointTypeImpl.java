...
import uk.ac.glam.wcsclient.gml311.ControlPointType;
 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.ControlPointTypeImpl#getPosList <em>Pos List</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.ControlPointTypeImpl#getGeometricPositionGroup <em>Geometric Position Group</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.ControlPointTypeImpl#getPos <em>Pos</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.ControlPointTypeImpl#getPointProperty <em>Point Property</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ControlPointTypeImpl extends EObjectImpl implements ControlPointType {
	/**
	...
	protected EClass eStaticClass() {
		return Gml311Package.eINSTANCE.getControlPointType();
	}
	...
	public NotificationChain basicSetPosList(DirectPositionListType newPosList, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Gml311Package.CONTROL_POINT_TYPE__POS_LIST, oldPosList, newPosList);
	...
	public void setPosList(DirectPositionListType newPosList) {
		if (newPosList != posList) {
			...
			if (posList != null)
				msgs = ((InternalEObject)posList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Gml311Package.CONTROL_POINT_TYPE__POS_LIST, null, msgs);
			if (newPosList != null)
				msgs = ((InternalEObject)newPosList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Gml311Package.CONTROL_POINT_TYPE__POS_LIST, null, msgs);
			msgs = basicSetPosList(newPosList, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.CONTROL_POINT_TYPE__POS_LIST, newPosList, newPosList));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case Gml311Package.CONTROL_POINT_TYPE__POS:
				return ((InternalEList<?>)getPos()).basicRemove(otherEnd, msgs);
			case Gml311Package.CONTROL_POINT_TYPE__POINT_PROPERTY:
