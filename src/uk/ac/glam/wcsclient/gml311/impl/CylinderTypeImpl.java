 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.CylinderTypeImpl#getHorizontalCurveType <em>Horizontal Curve Type</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.impl.CylinderTypeImpl#getVerticalCurveType <em>Vertical Curve Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CylinderTypeImpl extends AbstractGriddedSurfaceTypeImpl implements CylinderType {
	...
	public void setHorizontalCurveType(CurveInterpolationType newHorizontalCurveType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.CYLINDER_TYPE__HORIZONTAL_CURVE_TYPE, oldHorizontalCurveType, horizontalCurveType, !oldHorizontalCurveTypeESet));
	}
	...
	public void unsetHorizontalCurveType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Gml311Package.CYLINDER_TYPE__HORIZONTAL_CURVE_TYPE, oldHorizontalCurveType, HORIZONTAL_CURVE_TYPE_EDEFAULT, oldHorizontalCurveTypeESet));
	}
	...
	public void setVerticalCurveType(CurveInterpolationType newVerticalCurveType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Gml311Package.CYLINDER_TYPE__VERTICAL_CURVE_TYPE, oldVerticalCurveType, verticalCurveType, !oldVerticalCurveTypeESet));
	}
	...
	public void unsetVerticalCurveType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Gml311Package.CYLINDER_TYPE__VERTICAL_CURVE_TYPE, oldVerticalCurveType, VERTICAL_CURVE_TYPE_EDEFAULT, oldVerticalCurveTypeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Gml311Package.CYLINDER_TYPE__HORIZONTAL_CURVE_TYPE:
				return getHorizontalCurveType();
			case Gml311Package.CYLINDER_TYPE__VERTICAL_CURVE_TYPE:
