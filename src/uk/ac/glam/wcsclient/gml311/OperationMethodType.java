 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.OperationMethodType#getMethodID <em>Method ID</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.OperationMethodType#getRemarks <em>Remarks</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.OperationMethodType#getMethodFormula <em>Method Formula</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.OperationMethodType#getSourceDimensions <em>Source Dimensions</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.OperationMethodType#getTargetDimensions <em>Target Dimensions</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.gml311.OperationMethodType#getUsesParameter <em>Uses Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getOperationMethodType()
...
public interface OperationMethodType extends OperationMethodBaseType {
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getOperationMethodType_MethodID()
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getOperationMethodType_Remarks()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.gml311.OperationMethodType#getRemarks <em>Remarks</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getOperationMethodType_MethodFormula()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.gml311.OperationMethodType#getMethodFormula <em>Method Formula</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getOperationMethodType_SourceDimensions()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.gml311.OperationMethodType#getSourceDimensions <em>Source Dimensions</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getOperationMethodType_TargetDimensions()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.PositiveInteger" required="true"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.gml311.OperationMethodType#getTargetDimensions <em>Target Dimensions</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link uk.ac.glam.wcsclient.gml311.AbstractGeneralOperationParameterRefType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.gml311.Gml311Package#getOperationMethodType_UsesParameter()
	 * @model containment="true"
