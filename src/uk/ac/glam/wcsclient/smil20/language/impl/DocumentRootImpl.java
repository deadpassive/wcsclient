...
import uk.ac.glam.wcsclient.smil20.language.DocumentRoot;
 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.DocumentRootImpl#getAnimate <em>Animate</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.DocumentRootImpl#getAnimateColor <em>Animate Color</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.DocumentRootImpl#getAnimateMotion <em>Animate Motion</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.DocumentRootImpl#getSet <em>Set</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot {
	...
	public EMap<String, String> getXMLNSPrefixMap() {
		if (xMLNSPrefixMap == null) {
			xMLNSPrefixMap = new EcoreEMap<String,String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class, this, LanguagePackage.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
		}
	...
	public EMap<String, String> getXSISchemaLocation() {
		if (xSISchemaLocation == null) {
			xSISchemaLocation = new EcoreEMap<String,String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class, this, LanguagePackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
		}
