 ...
 * $Id$
 */
package uk.ac.glam.wcsclient.smil20.language.impl;
...
import uk.ac.glam.wcsclient.smil20.impl.AnimateColorPrototypeImpl;

import uk.ac.glam.wcsclient.smil20.language.AnimateColorType;
 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getAlt <em>Alt</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getBegin <em>Begin</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getCalcMode <em>Calc Mode</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getDur <em>Dur</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getEnd <em>End</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getFill <em>Fill</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getFillDefault <em>Fill Default</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getLang <em>Lang</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getLongdesc <em>Longdesc</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getMax <em>Max</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getMin <em>Min</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getRepeat <em>Repeat</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getRepeatCount <em>Repeat Count</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getRepeatDur <em>Repeat Dur</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getRestart <em>Restart</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getRestartDefault <em>Restart Default</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#isSkipContent <em>Skip Content</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getSyncBehavior <em>Sync Behavior</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getSyncBehaviorDefault <em>Sync Behavior Default</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getSyncTolerance <em>Sync Tolerance</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getSyncToleranceDefault <em>Sync Tolerance Default</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getTargetElement <em>Target Element</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.smil20.language.impl.AnimateColorTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AnimateColorTypeImpl extends AnimateColorPrototypeImpl implements AnimateColorType {
	/**
	...
	protected EClass eStaticClass() {
		return LanguagePackage.Literals.ANIMATE_COLOR_TYPE;
	}
	...
	public void setAlt(String newAlt) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__ALT, oldAlt, alt));
	}
	...
	public void setBegin(String newBegin) {
		...
		begin = newBegin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__BEGIN, oldBegin, begin));
	}
	...
	public void setCalcMode(CalcModeType newCalcMode) {
		...
		calcModeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__CALC_MODE, oldCalcMode, calcMode, !oldCalcModeESet));
	}
	...
	public void unsetCalcMode() {
		...
		calcModeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LanguagePackage.ANIMATE_COLOR_TYPE__CALC_MODE, oldCalcMode, CALC_MODE_EDEFAULT, oldCalcModeESet));
	}
	...
	public void setClass(String newClass) {
		...
		class_ = newClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__CLASS, oldClass, class_));
	}
	...
	public void setDur(String newDur) {
		...
		dur = newDur;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__DUR, oldDur, dur));
	}
	...
	public void setEnd(String newEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__END, oldEnd, end));
	}
	...
	public void setFill(FillTimingAttrsType newFill) {
		...
		fillESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__FILL, oldFill, fill, !oldFillESet));
	}
	...
	public void unsetFill() {
		...
		fillESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LanguagePackage.ANIMATE_COLOR_TYPE__FILL, oldFill, FILL_EDEFAULT, oldFillESet));
	}
	...
	public void setFillDefault(FillDefaultType newFillDefault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__FILL_DEFAULT, oldFillDefault, fillDefault, !oldFillDefaultESet));
	}
	...
	public void unsetFillDefault() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LanguagePackage.ANIMATE_COLOR_TYPE__FILL_DEFAULT, oldFillDefault, FILL_DEFAULT_EDEFAULT, oldFillDefaultESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__ID, oldId, id));
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__LANG, oldLang, lang));
	}
	...
	public void setLongdesc(String newLongdesc) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__LONGDESC, oldLongdesc, longdesc));
	}
	...
	public void setMax(String newMax) {
		...
		max = newMax;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__MAX, oldMax, max));
	}
	...
	public void setMin(String newMin) {
		...
		min = newMin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__MIN, oldMin, min));
	}
	...
	public void setRepeat(BigInteger newRepeat) {
		...
		repeat = newRepeat;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__REPEAT, oldRepeat, repeat));
	}
	...
	public void setRepeatCount(BigDecimal newRepeatCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__REPEAT_COUNT, oldRepeatCount, repeatCount));
	}
	...
	public void setRepeatDur(String newRepeatDur) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__REPEAT_DUR, oldRepeatDur, repeatDur));
	}
	...
	public void setRestart(RestartTimingType newRestart) {
		...
		restartESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__RESTART, oldRestart, restart, !oldRestartESet));
	}
	...
	public void unsetRestart() {
		...
		restartESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LanguagePackage.ANIMATE_COLOR_TYPE__RESTART, oldRestart, RESTART_EDEFAULT, oldRestartESet));
	}
	...
	public void setRestartDefault(RestartDefaultType newRestartDefault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__RESTART_DEFAULT, oldRestartDefault, restartDefault, !oldRestartDefaultESet));
	}
	...
	public void unsetRestartDefault() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LanguagePackage.ANIMATE_COLOR_TYPE__RESTART_DEFAULT, oldRestartDefault, RESTART_DEFAULT_EDEFAULT, oldRestartDefaultESet));
	}
	...
	public void setSkipContent(boolean newSkipContent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__SKIP_CONTENT, oldSkipContent, skipContent, !oldSkipContentESet));
	}
	...
	public void unsetSkipContent() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LanguagePackage.ANIMATE_COLOR_TYPE__SKIP_CONTENT, oldSkipContent, SKIP_CONTENT_EDEFAULT, oldSkipContentESet));
	}
	...
	public void setSyncBehavior(SyncBehaviorType newSyncBehavior) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__SYNC_BEHAVIOR, oldSyncBehavior, syncBehavior, !oldSyncBehaviorESet));
	}
	...
	public void unsetSyncBehavior() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LanguagePackage.ANIMATE_COLOR_TYPE__SYNC_BEHAVIOR, oldSyncBehavior, SYNC_BEHAVIOR_EDEFAULT, oldSyncBehaviorESet));
	}
	...
	public void setSyncBehaviorDefault(SyncBehaviorDefaultType newSyncBehaviorDefault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__SYNC_BEHAVIOR_DEFAULT, oldSyncBehaviorDefault, syncBehaviorDefault, !oldSyncBehaviorDefaultESet));
	}
	...
	public void unsetSyncBehaviorDefault() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LanguagePackage.ANIMATE_COLOR_TYPE__SYNC_BEHAVIOR_DEFAULT, oldSyncBehaviorDefault, SYNC_BEHAVIOR_DEFAULT_EDEFAULT, oldSyncBehaviorDefaultESet));
	}
	...
	public void setSyncTolerance(String newSyncTolerance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__SYNC_TOLERANCE, oldSyncTolerance, syncTolerance));
	}
	...
	public void setSyncToleranceDefault(String newSyncToleranceDefault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__SYNC_TOLERANCE_DEFAULT, oldSyncToleranceDefault, syncToleranceDefault, !oldSyncToleranceDefaultESet));
	}
	...
	public void unsetSyncToleranceDefault() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LanguagePackage.ANIMATE_COLOR_TYPE__SYNC_TOLERANCE_DEFAULT, oldSyncToleranceDefault, SYNC_TOLERANCE_DEFAULT_EDEFAULT, oldSyncToleranceDefaultESet));
	}
	...
	public void setTargetElement(String newTargetElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LanguagePackage.ANIMATE_COLOR_TYPE__TARGET_ELEMENT, oldTargetElement, targetElement));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LanguagePackage.ANIMATE_COLOR_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case LanguagePackage.ANIMATE_COLOR_TYPE__ANY:
				return ((InternalEList<?>)getAny()).basicRemove(otherEnd, msgs);
			case LanguagePackage.ANIMATE_COLOR_TYPE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case LanguagePackage.ANIMATE_COLOR_TYPE__ALT:
				return getAlt();
			case LanguagePackage.ANIMATE_COLOR_TYPE__BEGIN:
				return getBegin();
			case LanguagePackage.ANIMATE_COLOR_TYPE__CALC_MODE:
				return getCalcMode();
			case LanguagePackage.ANIMATE_COLOR_TYPE__CLASS:
				return getClass_();
			case LanguagePackage.ANIMATE_COLOR_TYPE__DUR:
				return getDur();
			case LanguagePackage.ANIMATE_COLOR_TYPE__END:
				return getEnd();
			case LanguagePackage.ANIMATE_COLOR_TYPE__FILL:
				return getFill();
			case LanguagePackage.ANIMATE_COLOR_TYPE__FILL_DEFAULT:
				return getFillDefault();
			case LanguagePackage.ANIMATE_COLOR_TYPE__ID:
				return getId();
			case LanguagePackage.ANIMATE_COLOR_TYPE__LANG:
				return getLang();
			case LanguagePackage.ANIMATE_COLOR_TYPE__LONGDESC:
				return getLongdesc();
			case LanguagePackage.ANIMATE_COLOR_TYPE__MAX:
				return getMax();
			case LanguagePackage.ANIMATE_COLOR_TYPE__MIN:
				return getMin();
			case LanguagePackage.ANIMATE_COLOR_TYPE__REPEAT:
				return getRepeat();
			case LanguagePackage.ANIMATE_COLOR_TYPE__REPEAT_COUNT:
				return getRepeatCount();
			case LanguagePackage.ANIMATE_COLOR_TYPE__REPEAT_DUR:
				return getRepeatDur();
			case LanguagePackage.ANIMATE_COLOR_TYPE__RESTART:
				return getRestart();
			case LanguagePackage.ANIMATE_COLOR_TYPE__RESTART_DEFAULT:
				return getRestartDefault();
			case LanguagePackage.ANIMATE_COLOR_TYPE__SKIP_CONTENT:
				return isSkipContent();
			case LanguagePackage.ANIMATE_COLOR_TYPE__SYNC_BEHAVIOR:
				return getSyncBehavior();
			case LanguagePackage.ANIMATE_COLOR_TYPE__SYNC_BEHAVIOR_DEFAULT:
				return getSyncBehaviorDefault();
			case LanguagePackage.ANIMATE_COLOR_TYPE__SYNC_TOLERANCE:
				return getSyncTolerance();
			case LanguagePackage.ANIMATE_COLOR_TYPE__SYNC_TOLERANCE_DEFAULT:
				return getSyncToleranceDefault();
			case LanguagePackage.ANIMATE_COLOR_TYPE__TARGET_ELEMENT:
