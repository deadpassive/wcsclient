 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.RequestMethodType#getConstraint <em>Constraint</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getRequestMethodType()
...
public interface RequestMethodType extends OnlineResourceType {
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getRequestMethodType_Constraint()
