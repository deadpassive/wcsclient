 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ReferenceGroupTypeImpl#getAbstractReferenceBaseGroup <em>Abstract Reference Base Group</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ReferenceGroupTypeImpl#getAbstractReferenceBase <em>Abstract Reference Base</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReferenceGroupTypeImpl extends BasicIdentificationTypeImpl implements ReferenceGroupType {
	...
	protected EClass eStaticClass() {
		return Ows110Package.Literals.REFERENCE_GROUP_TYPE;
	}
	...
	public FeatureMap getAbstractReferenceBaseGroup() {
		if (abstractReferenceBaseGroup == null) {
			abstractReferenceBaseGroup = new BasicFeatureMap(this, Ows110Package.REFERENCE_GROUP_TYPE__ABSTRACT_REFERENCE_BASE_GROUP);
		}
	...
	public EList<AbstractReferenceBaseType> getAbstractReferenceBase() {
		return getAbstractReferenceBaseGroup().list(Ows110Package.Literals.REFERENCE_GROUP_TYPE__ABSTRACT_REFERENCE_BASE);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Ows110Package.REFERENCE_GROUP_TYPE__ABSTRACT_REFERENCE_BASE_GROUP:
				return ((InternalEList<?>)getAbstractReferenceBaseGroup()).basicRemove(otherEnd, msgs);
			case Ows110Package.REFERENCE_GROUP_TYPE__ABSTRACT_REFERENCE_BASE:
