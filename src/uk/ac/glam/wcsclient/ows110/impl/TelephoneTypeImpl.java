 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.TelephoneTypeImpl#getVoice <em>Voice</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.TelephoneTypeImpl#getFacsimile <em>Facsimile</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TelephoneTypeImpl extends EObjectImpl implements TelephoneType {
	...
	protected EClass eStaticClass() {
		return Ows110Package.Literals.TELEPHONE_TYPE;
	}
	...
	public EList<String> getVoice() {
		if (voice == null) {
			voice = new EDataTypeEList<String>(String.class, this, Ows110Package.TELEPHONE_TYPE__VOICE);
		}
		return voice;
	}
	...
	public EList<String> getFacsimile() {
		if (facsimile == null) {
			facsimile = new EDataTypeEList<String>(String.class, this, Ows110Package.TELEPHONE_TYPE__FACSIMILE);
		}
		return facsimile;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ows110Package.TELEPHONE_TYPE__VOICE:
				return getVoice();
			case Ows110Package.TELEPHONE_TYPE__FACSIMILE:
				return getFacsimile();
		}
