 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.DCPTypeImpl#getHTTP <em>HTTP</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DCPTypeImpl extends EObjectImpl implements DCPType {
	...
	protected EClass eStaticClass() {
		return Ows110Package.Literals.DCP_TYPE;
	}
	...
	public NotificationChain basicSetHTTP(HTTPType newHTTP, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Ows110Package.DCP_TYPE__HTTP, oldHTTP, newHTTP);
	...
	public void setHTTP(HTTPType newHTTP) {
		if (newHTTP != hTTP) {
			...
			if (hTTP != null)
				msgs = ((InternalEObject)hTTP).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Ows110Package.DCP_TYPE__HTTP, null, msgs);
			if (newHTTP != null)
				msgs = ((InternalEObject)newHTTP).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Ows110Package.DCP_TYPE__HTTP, null, msgs);
			msgs = basicSetHTTP(newHTTP, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.DCP_TYPE__HTTP, newHTTP, newHTTP));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Ows110Package.DCP_TYPE__HTTP:
