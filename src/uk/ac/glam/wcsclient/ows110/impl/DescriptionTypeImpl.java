 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.DescriptionTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.DescriptionTypeImpl#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.DescriptionTypeImpl#getKeywords <em>Keywords</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DescriptionTypeImpl extends EObjectImpl implements DescriptionType {
	...
	protected EClass eStaticClass() {
		return Ows110Package.Literals.DESCRIPTION_TYPE;
	}
	...
	public EList<LanguageStringType> getTitle() {
		if (title == null) {
			title = new EObjectContainmentEList<LanguageStringType>(LanguageStringType.class, this, Ows110Package.DESCRIPTION_TYPE__TITLE);
		}
		return title;
	}
	...
	public EList<LanguageStringType> getAbstract() {
		if (abstract_ == null) {
			abstract_ = new EObjectContainmentEList<LanguageStringType>(LanguageStringType.class, this, Ows110Package.DESCRIPTION_TYPE__ABSTRACT);
		}
		return abstract_;
	}
	...
	public EList<KeywordsType> getKeywords() {
		if (keywords == null) {
			keywords = new EObjectContainmentEList<KeywordsType>(KeywordsType.class, this, Ows110Package.DESCRIPTION_TYPE__KEYWORDS);
		}
		return keywords;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Ows110Package.DESCRIPTION_TYPE__TITLE:
				return ((InternalEList<?>)getTitle()).basicRemove(otherEnd, msgs);
			case Ows110Package.DESCRIPTION_TYPE__ABSTRACT:
				return ((InternalEList<?>)getAbstract()).basicRemove(otherEnd, msgs);
			case Ows110Package.DESCRIPTION_TYPE__KEYWORDS:
