...
import uk.ac.glam.wcsclient.ows110.AddressType;
...
import uk.ac.glam.wcsclient.ows110.ContentsBaseType;
...
import uk.ac.glam.wcsclient.ows110.RequestMethodType;
import uk.ac.glam.wcsclient.ows110.ResponsiblePartySubsetType;
...
import uk.ac.glam.wcsclient.ows110.TelephoneType;
...
import uk.ac.glam.wcsclient.ows110.util.Ows110Validator;
 ...
 * @generated
 */
public class Ows110PackageImpl extends EPackageImpl implements Ows110Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Ows110PackageImpl() {
		super(eNS_URI, Ows110Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Ows110Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Ows110Package init() {
		if (isInited) return (Ows110Package)EPackage.Registry.INSTANCE.getEPackage(Ows110Package.eNS_URI);

		// Obtain or create and register package
		Ows110PackageImpl theOws110Package = (Ows110PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Ows110PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Ows110PackageImpl());
			...
			(theOws110Package, 
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return Ows110Validator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theOws110Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Ows110Package.eNS_URI, theOws110Package);
		return theOws110Package;
	}
	 ...
	 * @generated
	 */
	public Ows110Factory getOws110Factory() {
		return (Ows110Factory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getAbstractReferenceBaseType_Actuate(), theXlinkPackage.getActuateType(), "actuate", null, 0, 1, AbstractReferenceBaseType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAbstractReferenceBaseType_Arcrole(), theXMLTypePackage.getAnyURI(), "arcrole", null, 0, 1, AbstractReferenceBaseType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAbstractReferenceBaseType_Href(), theXMLTypePackage.getAnyURI(), "href", null, 1, 1, AbstractReferenceBaseType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAbstractReferenceBaseType_Role(), theXMLTypePackage.getAnyURI(), "role", null, 0, 1, AbstractReferenceBaseType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAbstractReferenceBaseType_Show(), theXlinkPackage.getShowType(), "show", null, 0, 1, AbstractReferenceBaseType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAbstractReferenceBaseType_Title(), theXMLTypePackage.getString(), "title", null, 0, 1, AbstractReferenceBaseType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCapabilitiesBaseType_Version(), this.getVersionType1(), "version", null, 1, 1, CapabilitiesBaseType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDatasetDescriptionSummaryBaseType_BoundingBoxGroup(), ecorePackage.getEFeatureMapEntry(), "boundingBoxGroup", null, 0, -1, DatasetDescriptionSummaryBaseType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDocumentRoot_AbstractMetaData(), ecorePackage.getEObject(), null, "abstractMetaData", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDocumentRoot_Resource(), ecorePackage.getEObject(), null, "resource", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getExceptionReportType_Version(), this.getVersionType(), "version", null, 1, 1, ExceptionReportType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getGetResourceByIdType_Version(), this.getVersionType1(), "version", null, 1, 1, GetResourceByIdType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getIdentificationType_BoundingBoxGroup(), ecorePackage.getEFeatureMapEntry(), "boundingBoxGroup", null, 0, -1, IdentificationType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getLanguageStringType_Lang(), theXMLTypePackage.getAnySimpleType(), "lang", null, 0, 1, LanguageStringType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMetadataType_AbstractMetaDataGroup(), ecorePackage.getEFeatureMapEntry(), "abstractMetaDataGroup", null, 0, 1, MetadataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMetadataType_AbstractMetaData(), ecorePackage.getEObject(), null, "abstractMetaData", null, 0, 1, MetadataType.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMetadataType_Actuate(), theXlinkPackage.getActuateType(), "actuate", null, 0, 1, MetadataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMetadataType_Arcrole(), theXMLTypePackage.getAnyURI(), "arcrole", null, 0, 1, MetadataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMetadataType_Href(), theXMLTypePackage.getAnyURI(), "href", null, 0, 1, MetadataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMetadataType_Role(), theXMLTypePackage.getAnyURI(), "role", null, 0, 1, MetadataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMetadataType_Show(), theXlinkPackage.getShowType(), "show", null, 0, 1, MetadataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMetadataType_Title(), theXMLTypePackage.getString(), "title", null, 0, 1, MetadataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMetadataType_Type(), theXMLTypePackage.getString(), "type", "simple", 0, 1, MetadataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getServiceIdentificationType_ServiceTypeVersion(), this.getVersionType1(), "serviceTypeVersion", null, 1, -1, ServiceIdentificationType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createNullAnnotations() {
		...
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
			 "appinfo", "ows19115subset.xsd 2006-10-20"
		   });																																																																																																																																																																																																																																																																																																																																																																																																																																																																																									
	}
