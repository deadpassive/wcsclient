 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ContentsBaseTypeImpl#getDatasetDescriptionSummary <em>Dataset Description Summary</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ContentsBaseTypeImpl#getOtherSource <em>Other Source</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContentsBaseTypeImpl extends EObjectImpl implements ContentsBaseType {
	...
	protected EClass eStaticClass() {
		return Ows110Package.Literals.CONTENTS_BASE_TYPE;
	}
	...
	public EList<DatasetDescriptionSummaryBaseType> getDatasetDescriptionSummary() {
		if (datasetDescriptionSummary == null) {
			datasetDescriptionSummary = new EObjectContainmentEList<DatasetDescriptionSummaryBaseType>(DatasetDescriptionSummaryBaseType.class, this, Ows110Package.CONTENTS_BASE_TYPE__DATASET_DESCRIPTION_SUMMARY);
		}
	...
	public EList<MetadataType> getOtherSource() {
		if (otherSource == null) {
			otherSource = new EObjectContainmentEList<MetadataType>(MetadataType.class, this, Ows110Package.CONTENTS_BASE_TYPE__OTHER_SOURCE);
		}
		return otherSource;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Ows110Package.CONTENTS_BASE_TYPE__DATASET_DESCRIPTION_SUMMARY:
				return ((InternalEList<?>)getDatasetDescriptionSummary()).basicRemove(otherEnd, msgs);
			case Ows110Package.CONTENTS_BASE_TYPE__OTHER_SOURCE:
