 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.RequestMethodTypeImpl#getConstraint <em>Constraint</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RequestMethodTypeImpl extends OnlineResourceTypeImpl implements RequestMethodType {
	...
	protected EClass eStaticClass() {
		return Ows110Package.Literals.REQUEST_METHOD_TYPE;
	}
	...
	public EList<DomainType> getConstraint() {
		if (constraint == null) {
			constraint = new EObjectContainmentEList<DomainType>(DomainType.class, this, Ows110Package.REQUEST_METHOD_TYPE__CONSTRAINT);
		}
		return constraint;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Ows110Package.REQUEST_METHOD_TYPE__CONSTRAINT:
