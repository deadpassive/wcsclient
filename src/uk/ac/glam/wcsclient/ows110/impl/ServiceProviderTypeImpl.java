 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ServiceProviderTypeImpl#getProviderName <em>Provider Name</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ServiceProviderTypeImpl#getProviderSite <em>Provider Site</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.ServiceProviderTypeImpl#getServiceContact <em>Service Contact</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServiceProviderTypeImpl extends EObjectImpl implements ServiceProviderType {
	...
	protected EClass eStaticClass() {
		return Ows110Package.Literals.SERVICE_PROVIDER_TYPE;
	}
	...
	public void setProviderName(String newProviderName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.SERVICE_PROVIDER_TYPE__PROVIDER_NAME, oldProviderName, providerName));
	}
	...
	public NotificationChain basicSetProviderSite(OnlineResourceType newProviderSite, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Ows110Package.SERVICE_PROVIDER_TYPE__PROVIDER_SITE, oldProviderSite, newProviderSite);
	...
	public void setProviderSite(OnlineResourceType newProviderSite) {
		if (newProviderSite != providerSite) {
			...
			if (providerSite != null)
				msgs = ((InternalEObject)providerSite).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Ows110Package.SERVICE_PROVIDER_TYPE__PROVIDER_SITE, null, msgs);
			if (newProviderSite != null)
				msgs = ((InternalEObject)newProviderSite).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Ows110Package.SERVICE_PROVIDER_TYPE__PROVIDER_SITE, null, msgs);
			msgs = basicSetProviderSite(newProviderSite, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.SERVICE_PROVIDER_TYPE__PROVIDER_SITE, newProviderSite, newProviderSite));
	}
	...
	public NotificationChain basicSetServiceContact(ResponsiblePartySubsetType newServiceContact, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Ows110Package.SERVICE_PROVIDER_TYPE__SERVICE_CONTACT, oldServiceContact, newServiceContact);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setServiceContact(ResponsiblePartySubsetType newServiceContact) {
		if (newServiceContact != serviceContact) {
			...
			if (serviceContact != null)
				msgs = ((InternalEObject)serviceContact).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Ows110Package.SERVICE_PROVIDER_TYPE__SERVICE_CONTACT, null, msgs);
			if (newServiceContact != null)
				msgs = ((InternalEObject)newServiceContact).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Ows110Package.SERVICE_PROVIDER_TYPE__SERVICE_CONTACT, null, msgs);
			msgs = basicSetServiceContact(newServiceContact, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.SERVICE_PROVIDER_TYPE__SERVICE_CONTACT, newServiceContact, newServiceContact));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Ows110Package.SERVICE_PROVIDER_TYPE__PROVIDER_SITE:
				return basicSetProviderSite(null, msgs);
			case Ows110Package.SERVICE_PROVIDER_TYPE__SERVICE_CONTACT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ows110Package.SERVICE_PROVIDER_TYPE__PROVIDER_NAME:
