 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.CodeTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.CodeTypeImpl#getCodeSpace <em>Code Space</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CodeTypeImpl extends EObjectImpl implements CodeType {
	...
	protected EClass eStaticClass() {
		return Ows110Package.Literals.CODE_TYPE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.CODE_TYPE__VALUE, oldValue, value));
	}
	...
	public void setCodeSpace(String newCodeSpace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.CODE_TYPE__CODE_SPACE, oldCodeSpace, codeSpace));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ows110Package.CODE_TYPE__VALUE:
				return getValue();
			case Ows110Package.CODE_TYPE__CODE_SPACE:
				return getCodeSpace();
		}
