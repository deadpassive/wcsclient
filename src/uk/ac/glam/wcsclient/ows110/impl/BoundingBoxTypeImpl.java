 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.BoundingBoxTypeImpl#getLowerCorner <em>Lower Corner</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.BoundingBoxTypeImpl#getUpperCorner <em>Upper Corner</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.BoundingBoxTypeImpl#getCrs <em>Crs</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.impl.BoundingBoxTypeImpl#getDimensions <em>Dimensions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BoundingBoxTypeImpl extends EObjectImpl implements BoundingBoxType {
	...
	protected EClass eStaticClass() {
		return Ows110Package.Literals.BOUNDING_BOX_TYPE;
	}
	...
	public void setLowerCorner(List<Double> newLowerCorner) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.BOUNDING_BOX_TYPE__LOWER_CORNER, oldLowerCorner, lowerCorner));
	}
	...
	public void setUpperCorner(List<Double> newUpperCorner) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.BOUNDING_BOX_TYPE__UPPER_CORNER, oldUpperCorner, upperCorner));
	}
	...
	public void setCrs(String newCrs) {
		...
		crs = newCrs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.BOUNDING_BOX_TYPE__CRS, oldCrs, crs));
	}
	...
	public void setDimensions(BigInteger newDimensions) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ows110Package.BOUNDING_BOX_TYPE__DIMENSIONS, oldDimensions, dimensions));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Ows110Package.BOUNDING_BOX_TYPE__LOWER_CORNER:
				return getLowerCorner();
			case Ows110Package.BOUNDING_BOX_TYPE__UPPER_CORNER:
				return getUpperCorner();
			case Ows110Package.BOUNDING_BOX_TYPE__CRS:
				return getCrs();
			case Ows110Package.BOUNDING_BOX_TYPE__DIMENSIONS:
