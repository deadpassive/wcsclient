 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.ResponsiblePartySubsetType#getIndividualName <em>Individual Name</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.ResponsiblePartySubsetType#getPositionName <em>Position Name</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.ResponsiblePartySubsetType#getContactInfo <em>Contact Info</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.ResponsiblePartySubsetType#getRole <em>Role</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getResponsiblePartySubsetType()
...
public interface ResponsiblePartySubsetType extends EObject {
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getResponsiblePartySubsetType_IndividualName()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.ResponsiblePartySubsetType#getIndividualName <em>Individual Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getResponsiblePartySubsetType_PositionName()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.ResponsiblePartySubsetType#getPositionName <em>Position Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getResponsiblePartySubsetType_ContactInfo()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.ResponsiblePartySubsetType#getContactInfo <em>Contact Info</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getResponsiblePartySubsetType_Role()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.ResponsiblePartySubsetType#getRole <em>Role</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
