 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.BoundingBoxType#getLowerCorner <em>Lower Corner</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.BoundingBoxType#getUpperCorner <em>Upper Corner</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.BoundingBoxType#getCrs <em>Crs</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.BoundingBoxType#getDimensions <em>Dimensions</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getBoundingBoxType()
...
public interface BoundingBoxType extends EObject {
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getBoundingBoxType_LowerCorner()
	 * @model dataType="uk.ac.glam.wcsclient.ows110.PositionType" required="true" many="false"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.BoundingBoxType#getLowerCorner <em>Lower Corner</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getBoundingBoxType_UpperCorner()
	 * @model dataType="uk.ac.glam.wcsclient.ows110.PositionType" required="true" many="false"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.BoundingBoxType#getUpperCorner <em>Upper Corner</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setCrs(String)
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getBoundingBoxType_Crs()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.BoundingBoxType#getCrs <em>Crs</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getBoundingBoxType_Dimensions()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.BoundingBoxType#getDimensions <em>Dimensions</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
