 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.RangeType#getMinimumValue <em>Minimum Value</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.RangeType#getMaximumValue <em>Maximum Value</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.RangeType#getSpacing <em>Spacing</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.ows110.RangeType#getRangeClosure <em>Range Closure</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getRangeType()
...
public interface RangeType extends EObject {
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getRangeType_MinimumValue()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.RangeType#getMinimumValue <em>Minimum Value</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getRangeType_MaximumValue()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.RangeType#getMaximumValue <em>Maximum Value</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getRangeType_Spacing()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.RangeType#getSpacing <em>Spacing</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.ows110.Ows110Package#getRangeType_RangeClosure()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.ows110.RangeType#getRangeClosure <em>Range Closure</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link uk.ac.glam.wcsclient.ows110.RangeType#getRangeClosure <em>Range Closure</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetRangeClosure()
	 * @see #getRangeClosure()
	...
	/**
	 * Returns whether the value of the '{@link uk.ac.glam.wcsclient.ows110.RangeType#getRangeClosure <em>Range Closure</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
