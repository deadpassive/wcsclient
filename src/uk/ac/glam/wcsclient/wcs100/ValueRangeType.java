 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.ValueRangeType#getMin <em>Min</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.ValueRangeType#getMax <em>Max</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.ValueRangeType#isAtomic <em>Atomic</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.ValueRangeType#getClosure <em>Closure</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.ValueRangeType#getSemantic <em>Semantic</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.ValueRangeType#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getValueRangeType()
...
public interface ValueRangeType extends EObject {
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getValueRangeType_Min()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs100.ValueRangeType#getMin <em>Min</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getValueRangeType_Max()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs100.ValueRangeType#getMax <em>Max</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getValueRangeType_Atomic()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs100.ValueRangeType#isAtomic <em>Atomic</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link uk.ac.glam.wcsclient.wcs100.ValueRangeType#isAtomic <em>Atomic</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetAtomic()
	 * @see #isAtomic()
	...
	/**
	 * Returns whether the value of the '{@link uk.ac.glam.wcsclient.wcs100.ValueRangeType#isAtomic <em>Atomic</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getValueRangeType_Closure()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs100.ValueRangeType#getClosure <em>Closure</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link uk.ac.glam.wcsclient.wcs100.ValueRangeType#getClosure <em>Closure</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetClosure()
	 * @see #getClosure()
	...
	/**
	 * Returns whether the value of the '{@link uk.ac.glam.wcsclient.wcs100.ValueRangeType#getClosure <em>Closure</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getValueRangeType_Semantic()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs100.ValueRangeType#getSemantic <em>Semantic</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * Can be omitted when the datatype of values in this interval is xs:string, or the "type" attribute is included in an enclosing element. 
	 * <!-- end-model-doc -->
	 * @return the value of the '<em>Type</em>' attribute.
	 * @see #setType(String)
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getValueRangeType_Type()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.AnyURI"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs100.ValueRangeType#getType <em>Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
