 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.CoverageOfferingBriefType#getLonLatEnvelope <em>Lon Lat Envelope</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.CoverageOfferingBriefType#getKeywords <em>Keywords</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getCoverageOfferingBriefType()
...
public interface CoverageOfferingBriefType extends AbstractDescriptionType {
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getCoverageOfferingBriefType_LonLatEnvelope()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs100.CoverageOfferingBriefType#getLonLatEnvelope <em>Lon Lat Envelope</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getCoverageOfferingBriefType_Keywords()
