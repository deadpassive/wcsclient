 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.GetCoverageType1Impl#getDCPType <em>DCP Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GetCoverageType1Impl extends EObjectImpl implements GetCoverageType1 {
	...
	protected EClass eStaticClass() {
		return Wcs100Package.Literals.GET_COVERAGE_TYPE1;
	}
	...
	public EList<DCPTypeType> getDCPType() {
		if (dCPType == null) {
			dCPType = new EObjectContainmentEList<DCPTypeType>(DCPTypeType.class, this, Wcs100Package.GET_COVERAGE_TYPE1__DCP_TYPE);
		}
		return dCPType;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Wcs100Package.GET_COVERAGE_TYPE1__DCP_TYPE:
