 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.ServiceTypeImpl#getKeywords <em>Keywords</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.ServiceTypeImpl#getResponsibleParty <em>Responsible Party</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.ServiceTypeImpl#getFees <em>Fees</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.ServiceTypeImpl#getAccessConstraints <em>Access Constraints</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.ServiceTypeImpl#getUpdateSequence <em>Update Sequence</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.ServiceTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServiceTypeImpl extends AbstractDescriptionTypeImpl implements ServiceType {
	 ...
	 * @ordered
	 */
	protected EList<CodeListType> accessConstraints;
	...
	protected EClass eStaticClass() {
		return Wcs100Package.Literals.SERVICE_TYPE;
	}
	...
	public EList<KeywordsType> getKeywords() {
		if (keywords == null) {
			keywords = new EObjectContainmentEList<KeywordsType>(KeywordsType.class, this, Wcs100Package.SERVICE_TYPE__KEYWORDS);
		}
		return keywords;
	}
	...
	public NotificationChain basicSetResponsibleParty(ResponsiblePartyType newResponsibleParty, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Wcs100Package.SERVICE_TYPE__RESPONSIBLE_PARTY, oldResponsibleParty, newResponsibleParty);
	...
	public void setResponsibleParty(ResponsiblePartyType newResponsibleParty) {
		if (newResponsibleParty != responsibleParty) {
			...
			if (responsibleParty != null)
				msgs = ((InternalEObject)responsibleParty).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.SERVICE_TYPE__RESPONSIBLE_PARTY, null, msgs);
			if (newResponsibleParty != null)
				msgs = ((InternalEObject)newResponsibleParty).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.SERVICE_TYPE__RESPONSIBLE_PARTY, null, msgs);
			msgs = basicSetResponsibleParty(newResponsibleParty, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.SERVICE_TYPE__RESPONSIBLE_PARTY, newResponsibleParty, newResponsibleParty));
	}
	...
	public NotificationChain basicSetFees(CodeListType newFees, NotificationChain msgs) {
		...
		fees = newFees;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Wcs100Package.SERVICE_TYPE__FEES, oldFees, newFees);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFees(CodeListType newFees) {
		if (newFees != fees) {
			NotificationChain msgs = null;
			if (fees != null)
				msgs = ((InternalEObject)fees).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.SERVICE_TYPE__FEES, null, msgs);
			if (newFees != null)
				msgs = ((InternalEObject)newFees).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.SERVICE_TYPE__FEES, null, msgs);
			msgs = basicSetFees(newFees, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.SERVICE_TYPE__FEES, newFees, newFees));
	}
	 ...
	 * @generated
	 */
	public EList<CodeListType> getAccessConstraints() {
		if (accessConstraints == null) {
			accessConstraints = new EObjectContainmentEList<CodeListType>(CodeListType.class, this, Wcs100Package.SERVICE_TYPE__ACCESS_CONSTRAINTS);
		}
	...
	public void setUpdateSequence(String newUpdateSequence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.SERVICE_TYPE__UPDATE_SEQUENCE, oldUpdateSequence, updateSequence));
	}
	...
	public void setVersion(String newVersion) {
		...
		versionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.SERVICE_TYPE__VERSION, oldVersion, version, !oldVersionESet));
	}
	...
	public void unsetVersion() {
		...
		versionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Wcs100Package.SERVICE_TYPE__VERSION, oldVersion, VERSION_EDEFAULT, oldVersionESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Wcs100Package.SERVICE_TYPE__KEYWORDS:
				return ((InternalEList<?>)getKeywords()).basicRemove(otherEnd, msgs);
			case Wcs100Package.SERVICE_TYPE__RESPONSIBLE_PARTY:
				return basicSetResponsibleParty(null, msgs);
			case Wcs100Package.SERVICE_TYPE__FEES:
				return basicSetFees(null, msgs);
			case Wcs100Package.SERVICE_TYPE__ACCESS_CONSTRAINTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Wcs100Package.SERVICE_TYPE__UPDATE_SEQUENCE:
				return getUpdateSequence();
			case Wcs100Package.SERVICE_TYPE__VERSION:
				return getVersion();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case Wcs100Package.SERVICE_TYPE__ACCESS_CONSTRAINTS:
				...
				getAccessConstraints().addAll((Collection<? extends CodeListType>)newValue);
				return;
			case Wcs100Package.SERVICE_TYPE__UPDATE_SEQUENCE:
