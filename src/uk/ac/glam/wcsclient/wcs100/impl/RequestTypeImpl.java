 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.RequestTypeImpl#getGetCapabilities <em>Get Capabilities</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.RequestTypeImpl#getDescribeCoverage <em>Describe Coverage</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.RequestTypeImpl#getGetCoverage <em>Get Coverage</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RequestTypeImpl extends EObjectImpl implements RequestType {
	...
	protected EClass eStaticClass() {
		return Wcs100Package.Literals.REQUEST_TYPE;
	}
	...
	public NotificationChain basicSetGetCapabilities(GetCapabilitiesType1 newGetCapabilities, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Wcs100Package.REQUEST_TYPE__GET_CAPABILITIES, oldGetCapabilities, newGetCapabilities);
	...
	public void setGetCapabilities(GetCapabilitiesType1 newGetCapabilities) {
		if (newGetCapabilities != getCapabilities) {
			...
			if (getCapabilities != null)
				msgs = ((InternalEObject)getCapabilities).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.REQUEST_TYPE__GET_CAPABILITIES, null, msgs);
			if (newGetCapabilities != null)
				msgs = ((InternalEObject)newGetCapabilities).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.REQUEST_TYPE__GET_CAPABILITIES, null, msgs);
			msgs = basicSetGetCapabilities(newGetCapabilities, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.REQUEST_TYPE__GET_CAPABILITIES, newGetCapabilities, newGetCapabilities));
	}
	...
	public NotificationChain basicSetDescribeCoverage(DescribeCoverageType1 newDescribeCoverage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Wcs100Package.REQUEST_TYPE__DESCRIBE_COVERAGE, oldDescribeCoverage, newDescribeCoverage);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDescribeCoverage(DescribeCoverageType1 newDescribeCoverage) {
		if (newDescribeCoverage != describeCoverage) {
			...
			if (describeCoverage != null)
				msgs = ((InternalEObject)describeCoverage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.REQUEST_TYPE__DESCRIBE_COVERAGE, null, msgs);
			if (newDescribeCoverage != null)
				msgs = ((InternalEObject)newDescribeCoverage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.REQUEST_TYPE__DESCRIBE_COVERAGE, null, msgs);
			msgs = basicSetDescribeCoverage(newDescribeCoverage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.REQUEST_TYPE__DESCRIBE_COVERAGE, newDescribeCoverage, newDescribeCoverage));
	}
	...
	public NotificationChain basicSetGetCoverage(GetCoverageType1 newGetCoverage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Wcs100Package.REQUEST_TYPE__GET_COVERAGE, oldGetCoverage, newGetCoverage);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setGetCoverage(GetCoverageType1 newGetCoverage) {
		if (newGetCoverage != getCoverage) {
			NotificationChain msgs = null;
			if (getCoverage != null)
				msgs = ((InternalEObject)getCoverage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.REQUEST_TYPE__GET_COVERAGE, null, msgs);
			if (newGetCoverage != null)
				msgs = ((InternalEObject)newGetCoverage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.REQUEST_TYPE__GET_COVERAGE, null, msgs);
			msgs = basicSetGetCoverage(newGetCoverage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.REQUEST_TYPE__GET_COVERAGE, newGetCoverage, newGetCoverage));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Wcs100Package.REQUEST_TYPE__GET_CAPABILITIES:
				return basicSetGetCapabilities(null, msgs);
			case Wcs100Package.REQUEST_TYPE__DESCRIBE_COVERAGE:
				return basicSetDescribeCoverage(null, msgs);
			case Wcs100Package.REQUEST_TYPE__GET_COVERAGE:
