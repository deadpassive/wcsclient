...
import uk.ac.glam.wcsclient.wcs100.AbstractDescriptionType;
...
import uk.ac.glam.wcsclient.wcs100.CapabilitiesSectionType;
import uk.ac.glam.wcsclient.wcs100.ClosureType;
import uk.ac.glam.wcsclient.wcs100.ContactType;
...
import uk.ac.glam.wcsclient.wcs100.GetCoverageType1;
...
import uk.ac.glam.wcsclient.wcs100.LonLatEnvelopeBaseType;
import uk.ac.glam.wcsclient.wcs100.LonLatEnvelopeType;
import uk.ac.glam.wcsclient.wcs100.MetadataAssociationType;
import uk.ac.glam.wcsclient.wcs100.MetadataLinkType;
import uk.ac.glam.wcsclient.wcs100.MetadataTypeType;
import uk.ac.glam.wcsclient.wcs100.OnlineResourceType;
...
import uk.ac.glam.wcsclient.wcs100.ResponsiblePartyType;
...
import uk.ac.glam.wcsclient.wcs100.ValueEnumBaseType;
import uk.ac.glam.wcsclient.wcs100.ValueEnumType;
import uk.ac.glam.wcsclient.wcs100.ValueRangeType;
...
import uk.ac.glam.wcsclient.wcs100.Wcs100Factory;
import uk.ac.glam.wcsclient.wcs100.Wcs100Package;

import uk.ac.glam.wcsclient.wcs100.gml.GmlPackage;

import uk.ac.glam.wcsclient.wcs100.gml.impl.GmlPackageImpl;

import uk.ac.glam.wcsclient.wcs100.xlink.XlinkPackage;

import uk.ac.glam.wcsclient.wcs100.xlink.impl.XlinkPackageImpl;
 ...
 * @generated
 */
public class Wcs100PackageImpl extends EPackageImpl implements Wcs100Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Wcs100PackageImpl() {
		super(eNS_URI, Wcs100Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Wcs100Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Wcs100Package init() {
		if (isInited) return (Wcs100Package)EPackage.Registry.INSTANCE.getEPackage(Wcs100Package.eNS_URI);

		// Obtain or create and register package
		Wcs100PackageImpl theWcs100Package = (Wcs100PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Wcs100PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Wcs100PackageImpl());
		...
		theWcs100Package.createPackageContents();
		theGmlPackage.createPackageContents();
		theXlinkPackage.createPackageContents();

		// Initialize created meta-data
		theWcs100Package.initializePackageContents();
		theGmlPackage.initializePackageContents();
		theXlinkPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theWcs100Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Wcs100Package.eNS_URI, theWcs100Package);
		return theWcs100Package;
	}
	 ...
	 * @generated
	 */
	public EReference getAbstractDescriptionBaseType_MetadataLink() {
		return (EReference)abstractDescriptionBaseTypeEClass.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getAbstractDescriptionType_Description1() {
		return (EAttribute)abstractDescriptionTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getSpatialDomainType_EnvelopeGroup() {
	 ...
	 * @generated
	 */
	public Wcs100Factory getWcs100Factory() {
		return (Wcs100Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(abstractDescriptionBaseTypeEClass, ABSTRACT_DESCRIPTION_BASE_TYPE__METADATA_LINK);
		...
		createEAttribute(spatialDomainTypeEClass, SPATIAL_DOMAIN_TYPE__ENVELOPE_GROUP);
	...
	public void initializePackageContents() {
		...
		initEReference(getAbstractDescriptionBaseType_MetadataLink(), this.getMetadataLinkType(), null, "metadataLink", null, 0, -1, AbstractDescriptionBaseType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getContentMetadataType_Actuate(), theXlinkPackage.getActuateType(), "actuate", null, 0, 1, ContentMetadataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getContentMetadataType_Show(), theXlinkPackage.getShowType(), "show", null, 0, 1, ContentMetadataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDescribeCoverageType_Coverage(), theXMLTypePackage.getString(), "coverage", null, 0, -1, DescribeCoverageType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDocumentRoot_InterpolationMethod(), this.getInterpolationMethodType(), "interpolationMethod", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getGetCoverageType_InterpolationMethod(), this.getInterpolationMethodType(), "interpolationMethod", null, 0, 1, GetCoverageType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMetadataLinkType_MetadataType(), this.getMetadataTypeType(), "metadataType", null, 1, 1, MetadataLinkType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSpatialDomainType_EnvelopeGroup(), ecorePackage.getEFeatureMapEntry(), "envelopeGroup", null, 1, -1, SpatialDomainType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSpatialDomainType_Envelope(), theGmlPackage.getEnvelopeType(), null, "envelope", null, 1, -1, SpatialDomainType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getSpatialDomainType_GridGroup(), ecorePackage.getEFeatureMapEntry(), "gridGroup", null, 0, -1, SpatialDomainType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getValueEnumBaseType_Group(), ecorePackage.getEFeatureMapEntry(), "group", null, 0, -1, ValueEnumBaseType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getValueRangeType_Closure(), this.getClosureType(), "closure", null, 0, 1, ValueRangeType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getVendorSpecificCapabilitiesType_Any(), ecorePackage.getEFeatureMapEntry(), "any", null, 1, 1, VendorSpecificCapabilitiesType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(capabilitiesSectionTypeEEnum, CapabilitiesSectionType._);
		addEEnumLiteral(capabilitiesSectionTypeEEnum, CapabilitiesSectionType.WCS_CAPABILITIES_SERVICE);
		addEEnumLiteral(capabilitiesSectionTypeEEnum, CapabilitiesSectionType.WCS_CAPABILITIES_CAPABILITY);
		addEEnumLiteral(capabilitiesSectionTypeEEnum, CapabilitiesSectionType.WCS_CAPABILITIES_CONTENT_METADATA);

		initEEnum(closureTypeEEnum, ClosureType.class, "ClosureType");
		addEEnumLiteral(closureTypeEEnum, ClosureType.CLOSED);
		addEEnumLiteral(closureTypeEEnum, ClosureType.OPEN);
		...
		addEEnumLiteral(interpolationMethodTypeEEnum, InterpolationMethodType.NEAREST_NEIGHBOR);
		addEEnumLiteral(interpolationMethodTypeEEnum, InterpolationMethodType.BILINEAR);
		addEEnumLiteral(interpolationMethodTypeEEnum, InterpolationMethodType.BICUBIC);
		addEEnumLiteral(interpolationMethodTypeEEnum, InterpolationMethodType.LOST_AREA);
		addEEnumLiteral(interpolationMethodTypeEEnum, InterpolationMethodType.BARYCENTRIC);
		addEEnumLiteral(interpolationMethodTypeEEnum, InterpolationMethodType.NONE);

		initEEnum(metadataTypeTypeEEnum, MetadataTypeType.class, "MetadataTypeType");
		addEEnumLiteral(metadataTypeTypeEEnum, MetadataTypeType.TC211);
		addEEnumLiteral(metadataTypeTypeEEnum, MetadataTypeType.FGDC);
		addEEnumLiteral(metadataTypeTypeEEnum, MetadataTypeType.OTHER);
	...
	protected void createNullAnnotations() {
		...
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
			 "appinfo", "describeCoverage.xsd v1.0.1 2005-07-18\r\nwcsCapabilities.xsd v1.0.1 2005-07-18\r\nowsBase.xsd v1.0.0 2004-07-15\r\ngml4wcs.xsd v1.0.0 2003-07-29\r\nvalues.xsd v1.0.1 2005-07-18"
		   });																																																																																																																																																																																																																																																																																																																																																																																																											
	}
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (getAbstractDescriptionBaseType_MetadataLink(), 
		   source, 
		   new String[] {
			 "kind", "element",
			 "name", "metadataLink",
		...
		addAnnotation
		  (getDescribeCoverageType_Coverage(), 
		   source, 
		   new String[] {
			 "kind", "element",
			 "name", "Coverage",
		...
		addAnnotation
		  (getSpatialDomainType_EnvelopeGroup(), 
		   source, 
		   new String[] {
			 "kind", "group",
			 "name", "Envelope:group",
