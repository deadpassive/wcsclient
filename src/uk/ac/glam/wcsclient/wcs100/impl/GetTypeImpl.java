 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.GetTypeImpl#getOnlineResource <em>Online Resource</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GetTypeImpl extends EObjectImpl implements GetType {
	...
	protected EClass eStaticClass() {
		return Wcs100Package.Literals.GET_TYPE;
	}
	...
	public NotificationChain basicSetOnlineResource(OnlineResourceType newOnlineResource, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Wcs100Package.GET_TYPE__ONLINE_RESOURCE, oldOnlineResource, newOnlineResource);
	...
	public void setOnlineResource(OnlineResourceType newOnlineResource) {
		if (newOnlineResource != onlineResource) {
			...
			if (onlineResource != null)
				msgs = ((InternalEObject)onlineResource).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.GET_TYPE__ONLINE_RESOURCE, null, msgs);
			if (newOnlineResource != null)
				msgs = ((InternalEObject)newOnlineResource).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.GET_TYPE__ONLINE_RESOURCE, null, msgs);
			msgs = basicSetOnlineResource(newOnlineResource, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.GET_TYPE__ONLINE_RESOURCE, newOnlineResource, newOnlineResource));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Wcs100Package.GET_TYPE__ONLINE_RESOURCE:
