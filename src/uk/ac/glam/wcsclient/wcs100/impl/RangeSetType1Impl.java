 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.RangeSetType1Impl#getRangeSet <em>Range Set</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RangeSetType1Impl extends EObjectImpl implements RangeSetType1 {
	...
	protected EClass eStaticClass() {
		return Wcs100Package.Literals.RANGE_SET_TYPE1;
	}
	...
	public NotificationChain basicSetRangeSet(RangeSetType newRangeSet, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Wcs100Package.RANGE_SET_TYPE1__RANGE_SET, oldRangeSet, newRangeSet);
	...
	public void setRangeSet(RangeSetType newRangeSet) {
		if (newRangeSet != rangeSet) {
			...
			if (rangeSet != null)
				msgs = ((InternalEObject)rangeSet).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.RANGE_SET_TYPE1__RANGE_SET, null, msgs);
			if (newRangeSet != null)
				msgs = ((InternalEObject)newRangeSet).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.RANGE_SET_TYPE1__RANGE_SET, null, msgs);
			msgs = basicSetRangeSet(newRangeSet, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.RANGE_SET_TYPE1__RANGE_SET, newRangeSet, newRangeSet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Wcs100Package.RANGE_SET_TYPE1__RANGE_SET:
