 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.CoverageOfferingTypeImpl#getDomainSet <em>Domain Set</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.CoverageOfferingTypeImpl#getRangeSet <em>Range Set</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.CoverageOfferingTypeImpl#getSupportedCRSs <em>Supported CR Ss</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.CoverageOfferingTypeImpl#getSupportedFormats <em>Supported Formats</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.CoverageOfferingTypeImpl#getSupportedInterpolations <em>Supported Interpolations</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CoverageOfferingTypeImpl extends CoverageOfferingBriefTypeImpl implements CoverageOfferingType {
	...
	protected EClass eStaticClass() {
		return Wcs100Package.Literals.COVERAGE_OFFERING_TYPE;
	}
	...
	public NotificationChain basicSetDomainSet(DomainSetType newDomainSet, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Wcs100Package.COVERAGE_OFFERING_TYPE__DOMAIN_SET, oldDomainSet, newDomainSet);
	...
	public void setDomainSet(DomainSetType newDomainSet) {
		if (newDomainSet != domainSet) {
			...
			if (domainSet != null)
				msgs = ((InternalEObject)domainSet).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.COVERAGE_OFFERING_TYPE__DOMAIN_SET, null, msgs);
			if (newDomainSet != null)
				msgs = ((InternalEObject)newDomainSet).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.COVERAGE_OFFERING_TYPE__DOMAIN_SET, null, msgs);
			msgs = basicSetDomainSet(newDomainSet, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.COVERAGE_OFFERING_TYPE__DOMAIN_SET, newDomainSet, newDomainSet));
	}
	...
	public NotificationChain basicSetRangeSet(RangeSetType1 newRangeSet, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Wcs100Package.COVERAGE_OFFERING_TYPE__RANGE_SET, oldRangeSet, newRangeSet);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRangeSet(RangeSetType1 newRangeSet) {
		if (newRangeSet != rangeSet) {
			NotificationChain msgs = null;
			if (rangeSet != null)
				msgs = ((InternalEObject)rangeSet).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.COVERAGE_OFFERING_TYPE__RANGE_SET, null, msgs);
			if (newRangeSet != null)
				msgs = ((InternalEObject)newRangeSet).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.COVERAGE_OFFERING_TYPE__RANGE_SET, null, msgs);
			msgs = basicSetRangeSet(newRangeSet, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.COVERAGE_OFFERING_TYPE__RANGE_SET, newRangeSet, newRangeSet));
	}
	...
	public NotificationChain basicSetSupportedCRSs(SupportedCRSsType newSupportedCRSs, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Wcs100Package.COVERAGE_OFFERING_TYPE__SUPPORTED_CR_SS, oldSupportedCRSs, newSupportedCRSs);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSupportedCRSs(SupportedCRSsType newSupportedCRSs) {
		if (newSupportedCRSs != supportedCRSs) {
			...
			if (supportedCRSs != null)
				msgs = ((InternalEObject)supportedCRSs).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.COVERAGE_OFFERING_TYPE__SUPPORTED_CR_SS, null, msgs);
			if (newSupportedCRSs != null)
				msgs = ((InternalEObject)newSupportedCRSs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.COVERAGE_OFFERING_TYPE__SUPPORTED_CR_SS, null, msgs);
			msgs = basicSetSupportedCRSs(newSupportedCRSs, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.COVERAGE_OFFERING_TYPE__SUPPORTED_CR_SS, newSupportedCRSs, newSupportedCRSs));
	}
	...
	public NotificationChain basicSetSupportedFormats(SupportedFormatsType newSupportedFormats, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Wcs100Package.COVERAGE_OFFERING_TYPE__SUPPORTED_FORMATS, oldSupportedFormats, newSupportedFormats);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSupportedFormats(SupportedFormatsType newSupportedFormats) {
		if (newSupportedFormats != supportedFormats) {
			...
			if (supportedFormats != null)
				msgs = ((InternalEObject)supportedFormats).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.COVERAGE_OFFERING_TYPE__SUPPORTED_FORMATS, null, msgs);
			if (newSupportedFormats != null)
				msgs = ((InternalEObject)newSupportedFormats).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.COVERAGE_OFFERING_TYPE__SUPPORTED_FORMATS, null, msgs);
			msgs = basicSetSupportedFormats(newSupportedFormats, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.COVERAGE_OFFERING_TYPE__SUPPORTED_FORMATS, newSupportedFormats, newSupportedFormats));
	}
	...
	public NotificationChain basicSetSupportedInterpolations(SupportedInterpolationsType newSupportedInterpolations, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Wcs100Package.COVERAGE_OFFERING_TYPE__SUPPORTED_INTERPOLATIONS, oldSupportedInterpolations, newSupportedInterpolations);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSupportedInterpolations(SupportedInterpolationsType newSupportedInterpolations) {
		if (newSupportedInterpolations != supportedInterpolations) {
			...
			if (supportedInterpolations != null)
				msgs = ((InternalEObject)supportedInterpolations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.COVERAGE_OFFERING_TYPE__SUPPORTED_INTERPOLATIONS, null, msgs);
			if (newSupportedInterpolations != null)
				msgs = ((InternalEObject)newSupportedInterpolations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.COVERAGE_OFFERING_TYPE__SUPPORTED_INTERPOLATIONS, null, msgs);
			msgs = basicSetSupportedInterpolations(newSupportedInterpolations, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.COVERAGE_OFFERING_TYPE__SUPPORTED_INTERPOLATIONS, newSupportedInterpolations, newSupportedInterpolations));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Wcs100Package.COVERAGE_OFFERING_TYPE__DOMAIN_SET:
				return basicSetDomainSet(null, msgs);
			case Wcs100Package.COVERAGE_OFFERING_TYPE__RANGE_SET:
				return basicSetRangeSet(null, msgs);
			case Wcs100Package.COVERAGE_OFFERING_TYPE__SUPPORTED_CR_SS:
				return basicSetSupportedCRSs(null, msgs);
			case Wcs100Package.COVERAGE_OFFERING_TYPE__SUPPORTED_FORMATS:
				return basicSetSupportedFormats(null, msgs);
			case Wcs100Package.COVERAGE_OFFERING_TYPE__SUPPORTED_INTERPOLATIONS:
