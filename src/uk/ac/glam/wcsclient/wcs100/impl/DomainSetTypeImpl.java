 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.DomainSetTypeImpl#getSpatialDomain <em>Spatial Domain</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.DomainSetTypeImpl#getTemporalDomain <em>Temporal Domain</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.impl.DomainSetTypeImpl#getTemporalDomain1 <em>Temporal Domain1</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DomainSetTypeImpl extends EObjectImpl implements DomainSetType {
	...
	protected EClass eStaticClass() {
		return Wcs100Package.Literals.DOMAIN_SET_TYPE;
	}
	...
	public NotificationChain basicSetSpatialDomain(SpatialDomainType newSpatialDomain, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Wcs100Package.DOMAIN_SET_TYPE__SPATIAL_DOMAIN, oldSpatialDomain, newSpatialDomain);
	...
	public void setSpatialDomain(SpatialDomainType newSpatialDomain) {
		if (newSpatialDomain != spatialDomain) {
			...
			if (spatialDomain != null)
				msgs = ((InternalEObject)spatialDomain).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.DOMAIN_SET_TYPE__SPATIAL_DOMAIN, null, msgs);
			if (newSpatialDomain != null)
				msgs = ((InternalEObject)newSpatialDomain).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.DOMAIN_SET_TYPE__SPATIAL_DOMAIN, null, msgs);
			msgs = basicSetSpatialDomain(newSpatialDomain, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.DOMAIN_SET_TYPE__SPATIAL_DOMAIN, newSpatialDomain, newSpatialDomain));
	}
	...
	public NotificationChain basicSetTemporalDomain(TimeSequenceType newTemporalDomain, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Wcs100Package.DOMAIN_SET_TYPE__TEMPORAL_DOMAIN, oldTemporalDomain, newTemporalDomain);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTemporalDomain(TimeSequenceType newTemporalDomain) {
		if (newTemporalDomain != temporalDomain) {
			...
			if (temporalDomain != null)
				msgs = ((InternalEObject)temporalDomain).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.DOMAIN_SET_TYPE__TEMPORAL_DOMAIN, null, msgs);
			if (newTemporalDomain != null)
				msgs = ((InternalEObject)newTemporalDomain).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.DOMAIN_SET_TYPE__TEMPORAL_DOMAIN, null, msgs);
			msgs = basicSetTemporalDomain(newTemporalDomain, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.DOMAIN_SET_TYPE__TEMPORAL_DOMAIN, newTemporalDomain, newTemporalDomain));
	}
	...
	public NotificationChain basicSetTemporalDomain1(TimeSequenceType newTemporalDomain1, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Wcs100Package.DOMAIN_SET_TYPE__TEMPORAL_DOMAIN1, oldTemporalDomain1, newTemporalDomain1);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTemporalDomain1(TimeSequenceType newTemporalDomain1) {
		if (newTemporalDomain1 != temporalDomain1) {
			...
			if (temporalDomain1 != null)
				msgs = ((InternalEObject)temporalDomain1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.DOMAIN_SET_TYPE__TEMPORAL_DOMAIN1, null, msgs);
			if (newTemporalDomain1 != null)
				msgs = ((InternalEObject)newTemporalDomain1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Wcs100Package.DOMAIN_SET_TYPE__TEMPORAL_DOMAIN1, null, msgs);
			msgs = basicSetTemporalDomain1(newTemporalDomain1, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wcs100Package.DOMAIN_SET_TYPE__TEMPORAL_DOMAIN1, newTemporalDomain1, newTemporalDomain1));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Wcs100Package.DOMAIN_SET_TYPE__SPATIAL_DOMAIN:
				return basicSetSpatialDomain(null, msgs);
			case Wcs100Package.DOMAIN_SET_TYPE__TEMPORAL_DOMAIN:
				return basicSetTemporalDomain(null, msgs);
			case Wcs100Package.DOMAIN_SET_TYPE__TEMPORAL_DOMAIN1:
