...
public class GmlValidator extends EObjectValidator {
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "uk.ac.glam.wcsclient.wcs100.gml";
	 ...
	 * @generated
	 */
	public boolean validateAbstractGeometryBaseType(AbstractGeometryBaseType abstractGeometryBaseType, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateTemporalPositionType(Object temporalPositionType, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateTemporalPositionType_MemberTypes(Object temporalPositionType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (diagnostics != null) {
			BasicDiagnostic tempDiagnostics = new BasicDiagnostic();
			if (XMLTypePackage.Literals.DATE_TIME.isInstance(temporalPositionType)) {
				if (xmlTypeValidator.validateDateTime((XMLGregorianCalendar)temporalPositionType, tempDiagnostics, context)) return true;
			}
			if (XMLTypePackage.Literals.DATE.isInstance(temporalPositionType)) {
				if (xmlTypeValidator.validateDate((XMLGregorianCalendar)temporalPositionType, tempDiagnostics, context)) return true;
			}
			if (XMLTypePackage.Literals.GYEAR_MONTH.isInstance(temporalPositionType)) {
				if (xmlTypeValidator.validateGYearMonth((XMLGregorianCalendar)temporalPositionType, tempDiagnostics, context)) return true;
			}
			if (XMLTypePackage.Literals.GYEAR.isInstance(temporalPositionType)) {
				if (xmlTypeValidator.validateGYear((XMLGregorianCalendar)temporalPositionType, tempDiagnostics, context)) return true;
			}
			...
			if (XMLTypePackage.Literals.DATE_TIME.isInstance(temporalPositionType)) {
				if (xmlTypeValidator.validateDateTime((XMLGregorianCalendar)temporalPositionType, null, context)) return true;
			}
			if (XMLTypePackage.Literals.DATE.isInstance(temporalPositionType)) {
				if (xmlTypeValidator.validateDate((XMLGregorianCalendar)temporalPositionType, null, context)) return true;
			}
			if (XMLTypePackage.Literals.GYEAR_MONTH.isInstance(temporalPositionType)) {
				if (xmlTypeValidator.validateGYearMonth((XMLGregorianCalendar)temporalPositionType, null, context)) return true;
			}
			if (XMLTypePackage.Literals.GYEAR.isInstance(temporalPositionType)) {
				if (xmlTypeValidator.validateGYear((XMLGregorianCalendar)temporalPositionType, null, context)) return true;
			}
			if (XMLTypePackage.Literals.ANY_URI.isInstance(temporalPositionType)) {
	 ...
	 * @generated
	 */
	public boolean validateVectorTypeBase(List<?> vectorTypeBase, DiagnosticChain diagnostics, Map<Object, Object> context) {
