 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.RangeSetType#getAxisDescription <em>Axis Description</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.RangeSetType#getNullValues <em>Null Values</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.RangeSetType#getRefSys <em>Ref Sys</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.RangeSetType#getRefSysLabel <em>Ref Sys Label</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.RangeSetType#getSemantic <em>Semantic</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getRangeSetType()
...
public interface RangeSetType extends AbstractDescriptionType {
	 ...
	 * The list contents are of type {@link uk.ac.glam.wcsclient.wcs100.AxisDescriptionType1}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getRangeSetType_AxisDescription()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='axisDescription' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<AxisDescriptionType1> getAxisDescription();
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getRangeSetType_NullValues()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs100.RangeSetType#getNullValues <em>Null Values</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getRangeSetType_RefSys()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs100.RangeSetType#getRefSys <em>Ref Sys</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getRangeSetType_RefSysLabel()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs100.RangeSetType#getRefSysLabel <em>Ref Sys Label</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getRangeSetType_Semantic()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.AnyURI"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs100.RangeSetType#getSemantic <em>Semantic</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
