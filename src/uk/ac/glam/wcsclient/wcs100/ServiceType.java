 ...
 * <ul>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.ServiceType#getKeywords <em>Keywords</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.ServiceType#getResponsibleParty <em>Responsible Party</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.ServiceType#getFees <em>Fees</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.ServiceType#getAccessConstraints <em>Access Constraints</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.ServiceType#getUpdateSequence <em>Update Sequence</em>}</li>
 *   <li>{@link uk.ac.glam.wcsclient.wcs100.ServiceType#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getServiceType()
...
public interface ServiceType extends AbstractDescriptionType {
	 ...
	 * The list contents are of type {@link uk.ac.glam.wcsclient.wcs100.KeywordsType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getServiceType_Keywords()
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getServiceType_ResponsibleParty()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs100.ServiceType#getResponsibleParty <em>Responsible Party</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getServiceType_Fees()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs100.ServiceType#getFees <em>Fees</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getServiceType_AccessConstraints()
	 * @model containment="true" required="true"
	 *        extendedMetaData="kind='element' name='accessConstraints' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<CodeListType> getAccessConstraints();
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getServiceType_UpdateSequence()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs100.ServiceType#getUpdateSequence <em>Update Sequence</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.glam.wcsclient.wcs100.Wcs100Package#getServiceType_Version()
	...
	/**
	 * Sets the value of the '{@link uk.ac.glam.wcsclient.wcs100.ServiceType#getVersion <em>Version</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link uk.ac.glam.wcsclient.wcs100.ServiceType#getVersion <em>Version</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetVersion()
	 * @see #getVersion()
	...
	/**
	 * Returns whether the value of the '{@link uk.ac.glam.wcsclient.wcs100.ServiceType#getVersion <em>Version</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
